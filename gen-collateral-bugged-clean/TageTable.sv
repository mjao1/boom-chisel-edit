  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s2_tag = _RANDOM[2'h0][14:8];
        io_f3_resp_0_valid_REG = _RANDOM[2'h0][15];
        io_f3_resp_0_bits_u_REG = _RANDOM[2'h0][17:16];
        io_f3_resp_0_bits_ctr_REG = _RANDOM[2'h0][20:18];
        io_f3_resp_1_valid_REG = _RANDOM[2'h0][21];
        io_f3_resp_1_bits_u_REG = _RANDOM[2'h0][23:22];
        io_f3_resp_1_bits_ctr_REG = _RANDOM[2'h0][26:24];
        io_f3_resp_2_valid_REG = _RANDOM[2'h0][27];
        io_f3_resp_2_bits_u_REG = _RANDOM[2'h0][29:28];
        io_f3_resp_2_bits_ctr_REG = {_RANDOM[2'h0][31:30], _RANDOM[2'h1][0]};
        io_f3_resp_3_valid_REG = _RANDOM[2'h1][1];
        io_f3_resp_3_bits_u_REG = _RANDOM[2'h1][3:2];
        io_f3_resp_3_bits_ctr_REG = _RANDOM[2'h1][6:4];
        clear_u_ctr = _RANDOM[2'h1][25:7];
        wrbypass_tags_0 = {_RANDOM[2'h1][31:26], _RANDOM[2'h2][0]};
        wrbypass_tags_1 = _RANDOM[2'h2][7:1];
        wrbypass_idxs_0 = _RANDOM[2'h2][14:8];
        wrbypass_idxs_1 = _RANDOM[2'h2][21:15];
        wrbypass_0_0 = _RANDOM[2'h2][24:22];
        wrbypass_0_1 = _RANDOM[2'h2][27:25];
        wrbypass_0_2 = _RANDOM[2'h2][30:28];
        wrbypass_0_3 = {_RANDOM[2'h2][31], _RANDOM[2'h3][1:0]};
        wrbypass_1_0 = _RANDOM[2'h3][4:2];
        wrbypass_1_1 = _RANDOM[2'h3][7:5];
        wrbypass_1_2 = _RANDOM[2'h3][10:8];
        wrbypass_1_3 = _RANDOM[2'h3][13:11];
        wrbypass_enq_idx = _RANDOM[2'h3][14];
      `endif // RANDOMIZE_REG_INIT
    end // initial
