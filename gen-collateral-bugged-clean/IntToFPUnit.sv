...
module IntToFPUnit(
  ...
  wire [19:0] io_resp_bits_uop_br_mask_0 = r_uops_1_br_mask & ~io_brupdate_b1_resolve_mask;
  `ifndef SYNTHESIS
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        r_valids_0 = _RANDOM[5'h0][0];
        r_valids_1 = _RANDOM[5'h0][1];
        r_uops_0_uopc = _RANDOM[5'h0][8:2];
        r_uops_0_inst = {_RANDOM[5'h0][31:9], _RANDOM[5'h1][8:0]};
        r_uops_0_debug_inst = {_RANDOM[5'h1][31:9], _RANDOM[5'h2][8:0]};
        r_uops_0_is_rvc = _RANDOM[5'h2][9];
        r_uops_0_debug_pc = {_RANDOM[5'h2][31:10], _RANDOM[5'h3][17:0]};
        r_uops_0_iq_type = _RANDOM[5'h3][20:18];
        r_uops_0_fu_code = _RANDOM[5'h3][30:21];
        r_uops_0_ctrl_br_type = {_RANDOM[5'h3][31], _RANDOM[5'h4][2:0]};
        r_uops_0_ctrl_op1_sel = _RANDOM[5'h4][4:3];
        r_uops_0_ctrl_op2_sel = _RANDOM[5'h4][7:5];
        r_uops_0_ctrl_imm_sel = _RANDOM[5'h4][10:8];
        r_uops_0_ctrl_op_fcn = _RANDOM[5'h4][15:11];
        r_uops_0_ctrl_fcn_dw = _RANDOM[5'h4][16];
        r_uops_0_ctrl_csr_cmd = _RANDOM[5'h4][19:17];
        r_uops_0_ctrl_is_load = _RANDOM[5'h4][20];
        r_uops_0_ctrl_is_sta = _RANDOM[5'h4][21];
        r_uops_0_ctrl_is_std = _RANDOM[5'h4][22];
        r_uops_0_iw_state = _RANDOM[5'h4][24:23];
        r_uops_0_iw_p1_poisoned = _RANDOM[5'h4][25];
        r_uops_0_iw_p2_poisoned = _RANDOM[5'h4][26];
        r_uops_0_is_br = _RANDOM[5'h4][27];
        r_uops_0_is_jalr = _RANDOM[5'h4][28];
        r_uops_0_is_jal = _RANDOM[5'h4][29];
        r_uops_0_is_sfb = _RANDOM[5'h4][30];
        r_uops_0_br_mask = {_RANDOM[5'h4][31], _RANDOM[5'h5][18:0]};
        r_uops_0_br_tag = _RANDOM[5'h5][23:19];
        r_uops_0_ftq_idx = _RANDOM[5'h5][29:24];
        r_uops_0_edge_inst = _RANDOM[5'h5][30];
        r_uops_0_pc_lob = {_RANDOM[5'h5][31], _RANDOM[5'h6][4:0]};
        r_uops_0_taken = _RANDOM[5'h6][5];
        r_uops_0_imm_packed = _RANDOM[5'h6][25:6];
        r_uops_0_csr_addr = {_RANDOM[5'h6][31:26], _RANDOM[5'h7][5:0]};
        r_uops_0_rob_idx = _RANDOM[5'h7][12:6];
        r_uops_0_ldq_idx = _RANDOM[5'h7][17:13];
        r_uops_0_stq_idx = _RANDOM[5'h7][22:18];
        r_uops_0_rxq_idx = _RANDOM[5'h7][24:23];
        r_uops_0_pdst = _RANDOM[5'h7][31:25];
        r_uops_0_prs1 = _RANDOM[5'h8][6:0];
        r_uops_0_prs2 = _RANDOM[5'h8][13:7];
        r_uops_0_prs3 = _RANDOM[5'h8][20:14];
        r_uops_0_ppred = _RANDOM[5'h8][26:21];
        r_uops_0_prs1_busy = _RANDOM[5'h8][27];
        r_uops_0_prs2_busy = _RANDOM[5'h8][28];
        r_uops_0_prs3_busy = _RANDOM[5'h8][29];
        r_uops_0_ppred_busy = _RANDOM[5'h8][30];
        r_uops_0_stale_pdst = {_RANDOM[5'h8][31], _RANDOM[5'h9][5:0]};
        r_uops_0_exception = _RANDOM[5'h9][6];
        r_uops_0_exc_cause = {_RANDOM[5'h9][31:7], _RANDOM[5'hA], _RANDOM[5'hB][6:0]};
        r_uops_0_bypassable = _RANDOM[5'hB][7];
        r_uops_0_mem_cmd = _RANDOM[5'hB][12:8];
        r_uops_0_mem_size = _RANDOM[5'hB][14:13];
        r_uops_0_mem_signed = _RANDOM[5'hB][15];
        r_uops_0_is_fence = _RANDOM[5'hB][16];
        r_uops_0_is_fencei = _RANDOM[5'hB][17];
        r_uops_0_is_amo = _RANDOM[5'hB][18];
        r_uops_0_uses_ldq = _RANDOM[5'hB][19];
        r_uops_0_uses_stq = _RANDOM[5'hB][20];
        r_uops_0_is_sys_pc2epc = _RANDOM[5'hB][21];
        r_uops_0_is_unique = _RANDOM[5'hB][22];
        r_uops_0_flush_on_commit = _RANDOM[5'hB][23];
        r_uops_0_ldst_is_rs1 = _RANDOM[5'hB][24];
        r_uops_0_ldst = _RANDOM[5'hB][30:25];
        r_uops_0_lrs1 = {_RANDOM[5'hB][31], _RANDOM[5'hC][4:0]};
        r_uops_0_lrs2 = _RANDOM[5'hC][10:5];
        r_uops_0_lrs3 = _RANDOM[5'hC][16:11];
        r_uops_0_ldst_val = _RANDOM[5'hC][17];
        r_uops_0_dst_rtype = _RANDOM[5'hC][19:18];
        r_uops_0_lrs1_rtype = _RANDOM[5'hC][21:20];
        r_uops_0_lrs2_rtype = _RANDOM[5'hC][23:22];
        r_uops_0_frs3_en = _RANDOM[5'hC][24];
        r_uops_0_fp_val = _RANDOM[5'hC][25];
        r_uops_0_fp_single = _RANDOM[5'hC][26];
        r_uops_0_xcpt_pf_if = _RANDOM[5'hC][27];
        r_uops_0_xcpt_ae_if = _RANDOM[5'hC][28];
        r_uops_0_xcpt_ma_if = _RANDOM[5'hC][29];
        r_uops_0_bp_debug_if = _RANDOM[5'hC][30];
        r_uops_0_bp_xcpt_if = _RANDOM[5'hC][31];
        r_uops_0_debug_fsrc = _RANDOM[5'hD][1:0];
        r_uops_0_debug_tsrc = _RANDOM[5'hD][3:2];
        r_uops_1_uopc = _RANDOM[5'hD][10:4];
        r_uops_1_inst = {_RANDOM[5'hD][31:11], _RANDOM[5'hE][10:0]};
        r_uops_1_debug_inst = {_RANDOM[5'hE][31:11], _RANDOM[5'hF][10:0]};
        r_uops_1_is_rvc = _RANDOM[5'hF][11];
        r_uops_1_debug_pc = {_RANDOM[5'hF][31:12], _RANDOM[5'h10][19:0]};
        r_uops_1_iq_type = _RANDOM[5'h10][22:20];
        r_uops_1_fu_code = {_RANDOM[5'h10][31:23], _RANDOM[5'h11][0]};
        r_uops_1_ctrl_br_type = _RANDOM[5'h11][4:1];
        r_uops_1_ctrl_op1_sel = _RANDOM[5'h11][6:5];
        r_uops_1_ctrl_op2_sel = _RANDOM[5'h11][9:7];
        r_uops_1_ctrl_imm_sel = _RANDOM[5'h11][12:10];
        r_uops_1_ctrl_op_fcn = _RANDOM[5'h11][17:13];
        r_uops_1_ctrl_fcn_dw = _RANDOM[5'h11][18];
        r_uops_1_ctrl_csr_cmd = _RANDOM[5'h11][21:19];
        r_uops_1_ctrl_is_load = _RANDOM[5'h11][22];
        r_uops_1_ctrl_is_sta = _RANDOM[5'h11][23];
        r_uops_1_ctrl_is_std = _RANDOM[5'h11][24];
        r_uops_1_iw_state = _RANDOM[5'h11][26:25];
        r_uops_1_iw_p1_poisoned = _RANDOM[5'h11][27];
        r_uops_1_iw_p2_poisoned = _RANDOM[5'h11][28];
        r_uops_1_is_br = _RANDOM[5'h11][29];
        r_uops_1_is_jalr = _RANDOM[5'h11][30];
        r_uops_1_is_jal = _RANDOM[5'h11][31];
        r_uops_1_is_sfb = _RANDOM[5'h12][0];
        r_uops_1_br_mask = _RANDOM[5'h12][20:1];
        r_uops_1_br_tag = _RANDOM[5'h12][25:21];
        r_uops_1_ftq_idx = _RANDOM[5'h12][31:26];
        r_uops_1_edge_inst = _RANDOM[5'h13][0];
        r_uops_1_pc_lob = _RANDOM[5'h13][6:1];
        r_uops_1_taken = _RANDOM[5'h13][7];
        r_uops_1_imm_packed = _RANDOM[5'h13][27:8];
        r_uops_1_csr_addr = {_RANDOM[5'h13][31:28], _RANDOM[5'h14][7:0]};
        r_uops_1_rob_idx = _RANDOM[5'h14][14:8];
        r_uops_1_ldq_idx = _RANDOM[5'h14][19:15];
        r_uops_1_stq_idx = _RANDOM[5'h14][24:20];
        r_uops_1_rxq_idx = _RANDOM[5'h14][26:25];
        r_uops_1_pdst = {_RANDOM[5'h14][31:27], _RANDOM[5'h15][1:0]};
        r_uops_1_prs1 = _RANDOM[5'h15][8:2];
        r_uops_1_prs2 = _RANDOM[5'h15][15:9];
        r_uops_1_prs3 = _RANDOM[5'h15][22:16];
        r_uops_1_ppred = _RANDOM[5'h15][28:23];
        r_uops_1_prs1_busy = _RANDOM[5'h15][29];
        r_uops_1_prs2_busy = _RANDOM[5'h15][30];
        r_uops_1_prs3_busy = _RANDOM[5'h15][31];
        r_uops_1_ppred_busy = _RANDOM[5'h16][0];
        r_uops_1_stale_pdst = _RANDOM[5'h16][7:1];
        r_uops_1_exception = _RANDOM[5'h16][8];
        r_uops_1_exc_cause = {_RANDOM[5'h16][31:9], _RANDOM[5'h17], _RANDOM[5'h18][8:0]};
        r_uops_1_bypassable = _RANDOM[5'h18][9];
        r_uops_1_mem_cmd = _RANDOM[5'h18][14:10];
        r_uops_1_mem_size = _RANDOM[5'h18][16:15];
        r_uops_1_mem_signed = _RANDOM[5'h18][17];
        r_uops_1_is_fence = _RANDOM[5'h18][18];
        r_uops_1_is_fencei = _RANDOM[5'h18][19];
        r_uops_1_is_amo = _RANDOM[5'h18][20];
        r_uops_1_uses_ldq = _RANDOM[5'h18][21];
        r_uops_1_uses_stq = _RANDOM[5'h18][22];
        r_uops_1_is_sys_pc2epc = _RANDOM[5'h18][23];
        r_uops_1_is_unique = _RANDOM[5'h18][24];
        r_uops_1_flush_on_commit = _RANDOM[5'h18][25];
        r_uops_1_ldst_is_rs1 = _RANDOM[5'h18][26];
        r_uops_1_ldst = {_RANDOM[5'h18][31:27], _RANDOM[5'h19][0]};
        r_uops_1_lrs1 = _RANDOM[5'h19][6:1];
        r_uops_1_lrs2 = _RANDOM[5'h19][12:7];
        r_uops_1_lrs3 = _RANDOM[5'h19][18:13];
        r_uops_1_ldst_val = _RANDOM[5'h19][19];
        r_uops_1_dst_rtype = _RANDOM[5'h19][21:20];
        r_uops_1_lrs1_rtype = _RANDOM[5'h19][23:22];
        r_uops_1_lrs2_rtype = _RANDOM[5'h19][25:24];
        r_uops_1_frs3_en = _RANDOM[5'h19][26];
        r_uops_1_fp_val = _RANDOM[5'h19][27];
        r_uops_1_fp_single = _RANDOM[5'h19][28];
        r_uops_1_xcpt_pf_if = _RANDOM[5'h19][29];
        r_uops_1_xcpt_ae_if = _RANDOM[5'h19][30];
        r_uops_1_xcpt_ma_if = _RANDOM[5'h19][31];
        r_uops_1_bp_debug_if = _RANDOM[5'h1A][0];
        r_uops_1_bp_xcpt_if = _RANDOM[5'h1A][1];
        r_uops_1_debug_fsrc = _RANDOM[5'h1A][3:2];
        r_uops_1_debug_tsrc = _RANDOM[5'h1A][5:4];
        out_double_pipe_v = _RANDOM[5'h1A][6];
        out_double_pipe_b = _RANDOM[5'h1A][7];
        out_double_pipe_pipe_b = _RANDOM[5'h1A][9];
      `endif // RANDOMIZE_REG_INIT
    end // initial
