...
module FPUExeUnit(
  ...
  wire        fp_sdq_io_enq_valid = io_req_valid & io_req_bits_uop_uopc == 7'h2 & (io_brupdate_b1_mispredict_mask & io_req_bits_uop_br_mask) == 20'h0;
  ...
  `ifndef SYNTHESIS
    always @(posedge clock) begin
      ...
      if (~reset & fp_sdq_io_enq_valid & ~_fp_sdq_io_enq_ready) begin
        if (`ASSERT_VERBOSE_COND_)
