...
module BranchPredictor(
  ...
  output         io_resp_f1_preds_4_is_br,
  output         io_resp_f1_preds_4_is_jal,
  output         io_resp_f1_preds_4_predicted_pc_valid,
  output [39:0]  io_resp_f1_preds_4_predicted_pc_bits,
  output         io_resp_f1_preds_5_taken,
  output         io_resp_f1_preds_5_is_br,
  output         io_resp_f1_preds_5_is_jal,
  output         io_resp_f1_preds_5_predicted_pc_valid,
  output [39:0]  io_resp_f1_preds_5_predicted_pc_bits,
  output         io_resp_f1_preds_6_taken,
  output         io_resp_f1_preds_6_is_br,
  output         io_resp_f1_preds_6_is_jal,
  output         io_resp_f1_preds_6_predicted_pc_valid,
  output [39:0]  io_resp_f1_preds_6_predicted_pc_bits,
  output         io_resp_f1_preds_7_taken,
  output         io_resp_f1_preds_7_is_br,
  output         io_resp_f1_preds_7_is_jal,
  output         io_resp_f1_preds_7_predicted_pc_valid,
  ...
  output         io_resp_f2_preds_4_is_br,
  output         io_resp_f2_preds_4_is_jal,
  output         io_resp_f2_preds_4_predicted_pc_valid,
  output [39:0]  io_resp_f2_preds_4_predicted_pc_bits,
  output         io_resp_f2_preds_5_taken,
  output         io_resp_f2_preds_5_is_br,
  output         io_resp_f2_preds_5_is_jal,
  output         io_resp_f2_preds_5_predicted_pc_valid,
  output [39:0]  io_resp_f2_preds_5_predicted_pc_bits,
  output         io_resp_f2_preds_6_taken,
  output         io_resp_f2_preds_6_is_br,
  output         io_resp_f2_preds_6_is_jal,
  output         io_resp_f2_preds_6_predicted_pc_valid,
  output [39:0]  io_resp_f2_preds_6_predicted_pc_bits,
  output         io_resp_f2_preds_7_taken,
  output         io_resp_f2_preds_7_is_br,
  output         io_resp_f2_preds_7_is_jal,
  output         io_resp_f2_preds_7_predicted_pc_valid,
  ...
  output         io_resp_f3_preds_4_is_br,
  output         io_resp_f3_preds_4_is_jal,
  output         io_resp_f3_preds_4_predicted_pc_valid,
  output [39:0]  io_resp_f3_preds_4_predicted_pc_bits,
  output         io_resp_f3_preds_5_taken,
  output         io_resp_f3_preds_5_is_br,
  output         io_resp_f3_preds_5_is_jal,
  output         io_resp_f3_preds_5_predicted_pc_valid,
  output [39:0]  io_resp_f3_preds_5_predicted_pc_bits,
  output         io_resp_f3_preds_6_taken,
  output         io_resp_f3_preds_6_is_br,
  output         io_resp_f3_preds_6_is_jal,
  output         io_resp_f3_preds_6_predicted_pc_valid,
  output [39:0]  io_resp_f3_preds_6_predicted_pc_bits,
  output         io_resp_f3_preds_7_taken,
  output         io_resp_f3_preds_7_is_br,
  output         io_resp_f3_preds_7_is_jal,
  output         io_resp_f3_preds_7_predicted_pc_valid,
  output [39:0]  io_resp_f3_preds_7_predicted_pc_bits,
  output [119:0] io_resp_f3_meta_0,
  output [119:0] io_resp_f3_meta_1,
  input          io_f3_fire,
  ...
  input  [119:0] io_update_bits_meta_1
);
  ...
  wire        banked_predictors_0_io_f0_valid = (io_f0_req_bits_pc[3] | io_f0_req_bits_pc[5:3] != 3'h7) & io_f0_req_valid;
  ...
  `ifndef SYNTHESIS
    wire [7:0] _GEN_3 = io_update_bits_br_mask >> io_update_bits_cfi_idx_bits;
    always @(posedge clock) begin
      if (io_update_valid & io_update_bits_cfi_is_br & io_update_bits_cfi_idx_valid & ~reset & ~(_GEN_3[0])) begin
  ...
  `endif // not def SYNTHESIS
  wire [64:0] _GEN_4 = {1'h0, io_f0_req_bits_ghist_old_history};
  always @(posedge clock) begin
    REG <= ~(io_f0_req_bits_pc[3]);
    banked_predictors_0_io_f1_ghist_REG <= io_f0_req_bits_ghist_old_history;
    banked_predictors_1_io_f1_ghist_REG <= io_f0_req_bits_ghist_new_saw_branch_taken ? {io_f0_req_bits_ghist_old_history, 1'h1} : io_f0_req_bits_ghist_new_saw_branch_not_taken ? {io_f0_req_bits_ghist_old_history, 1'h0} : _GEN_4;
    banked_predictors_0_io_f1_ghist_REG_1 <= io_f0_req_bits_ghist_new_saw_branch_taken ? {io_f0_req_bits_ghist_old_history, 1'h1} : io_f0_req_bits_ghist_new_saw_branch_not_taken ? {io_f0_req_bits_ghist_old_history, 1'h0} : _GEN_4;
    banked_predictors_1_io_f1_ghist_REG_1 <= io_f0_req_bits_ghist_old_history;
    b0_fire_REG <= banked_predictors_0_io_f0_valid;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        REG = _RANDOM[4'h0][0];
        banked_predictors_0_io_f1_ghist_REG = {_RANDOM[4'h0][31:1], _RANDOM[4'h1], _RANDOM[4'h2][0]};
        banked_predictors_1_io_f1_ghist_REG = {_RANDOM[4'h2][31:1], _RANDOM[4'h3], _RANDOM[4'h4][1:0]};
        banked_predictors_0_io_f1_ghist_REG_1 = {_RANDOM[4'h4][31:2], _RANDOM[4'h5], _RANDOM[4'h6][2:0]};
        banked_predictors_1_io_f1_ghist_REG_1 = {_RANDOM[4'h6][31:3], _RANDOM[4'h7], _RANDOM[4'h8][2:0]};
        b0_fire_REG = _RANDOM[4'h8][3];
        b0_fire_REG_1 = _RANDOM[4'h8][4];
        b0_fire_REG_2 = _RANDOM[4'h8][5];
        b1_fire_REG = _RANDOM[4'h8][6];
        b1_fire_REG_1 = _RANDOM[4'h8][7];
        b1_fire_REG_2 = _RANDOM[4'h8][8];
        io_resp_f1_pc_REG = {_RANDOM[4'h8][31:9], _RANDOM[4'h9][16:0]};
        io_resp_f2_pc_REG = {_RANDOM[4'h9][31:17], _RANDOM[4'hA][24:0]};
        io_resp_f3_pc_REG = {_RANDOM[4'hA][31:25], _RANDOM[4'hB], _RANDOM[4'hC][0]};
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  ComposedBranchPredictorBank banked_predictors_0 (
    ...
    .io_f0_mask                          (io_f0_req_bits_pc[3] ? _banked_predictors_0_io_f0_mask_T[3:0] : 4'hF),
  ...
  ComposedBranchPredictorBank banked_predictors_1 (
    ...
    .io_f0_mask                          (io_f0_req_bits_pc[3] ? 4'hF : _banked_predictors_1_io_f0_mask_T_1[3:0]),
