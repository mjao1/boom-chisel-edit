...
module BoomCore(
  ...
  input  [31:0] io_ifu_fetchpacket_bits_uops_1_bits_debug_inst,
  ...
  input         io_ifu_fetchpacket_bits_uops_1_bits_xcpt_ae_if,
  input         io_ifu_fetchpacket_bits_uops_1_bits_bp_debug_if,
  input         io_ifu_fetchpacket_bits_uops_1_bits_bp_xcpt_if,
  ...
  input  [31:0] io_ifu_fetchpacket_bits_uops_2_bits_debug_inst,
  ...
  input         io_ifu_fetchpacket_bits_uops_2_bits_xcpt_ae_if,
  input         io_ifu_fetchpacket_bits_uops_2_bits_bp_debug_if,
  input         io_ifu_fetchpacket_bits_uops_2_bits_bp_xcpt_if,
  ...
  input  [31:0] io_ifu_fetchpacket_bits_uops_3_bits_debug_inst,
  ...
  input         io_ifu_fetchpacket_bits_uops_3_bits_xcpt_ae_if,
  input         io_ifu_fetchpacket_bits_uops_3_bits_bp_debug_if,
  input         io_ifu_fetchpacket_bits_uops_3_bits_bp_xcpt_if,
  ...
  input  [39:0] io_ifu_get_pc_0_com_pc,
  ...
  input         io_ifu_get_pc_1_entry_cfi_is_ret,
  input         io_ifu_get_pc_1_entry_start_bank,
  input  [63:0] io_ifu_get_pc_1_ghist_old_history,
  input         io_ifu_get_pc_1_ghist_current_saw_branch_not_taken,
  input         io_ifu_get_pc_1_ghist_new_saw_branch_not_taken,
  input         io_ifu_get_pc_1_ghist_new_saw_branch_taken,
  input  [4:0]  io_ifu_get_pc_1_ghist_ras_idx,
  input  [39:0] io_ifu_get_pc_1_pc,
  output        io_ifu_sfence_valid,
  output        io_ifu_sfence_bits_rs1,
  output        io_ifu_sfence_bits_rs2,
  ...
  output        io_ifu_brupdate_b2_taken,
  output        io_ifu_redirect_flush,
  output        io_ifu_redirect_val,
  ...
  output        io_ifu_redirect_ghist_new_saw_branch_not_taken,
  output        io_ifu_redirect_ghist_new_saw_branch_taken,
  ...
  output [31:0] io_lsu_exe_0_req_bits_uop_debug_inst,
  ...
  output [2:0]  io_lsu_exe_0_req_bits_uop_ctrl_imm_sel,
  output [4:0]  io_lsu_exe_0_req_bits_uop_ctrl_op_fcn,
  ...
  output        io_lsu_exe_0_req_bits_uop_ctrl_is_sta,
  output        io_lsu_exe_0_req_bits_uop_ctrl_is_std,
  output [1:0]  io_lsu_exe_0_req_bits_uop_iw_state,
  output        io_lsu_exe_0_req_bits_uop_is_br,
  output        io_lsu_exe_0_req_bits_uop_is_jalr,
  output        io_lsu_exe_0_req_bits_uop_is_jal,
  output        io_lsu_exe_0_req_bits_uop_is_sfb,
  ...
  output [4:0]  io_lsu_exe_0_req_bits_uop_stq_idx,
  output [1:0]  io_lsu_exe_0_req_bits_uop_rxq_idx,
  output [6:0]  io_lsu_exe_0_req_bits_uop_pdst,
  output [6:0]  io_lsu_exe_0_req_bits_uop_prs1,
  output [6:0]  io_lsu_exe_0_req_bits_uop_prs2,
  output [6:0]  io_lsu_exe_0_req_bits_uop_prs3,
  output [5:0]  io_lsu_exe_0_req_bits_uop_ppred,
  output        io_lsu_exe_0_req_bits_uop_prs1_busy,
  output        io_lsu_exe_0_req_bits_uop_prs2_busy,
  output        io_lsu_exe_0_req_bits_uop_prs3_busy,
  output        io_lsu_exe_0_req_bits_uop_ppred_busy,
  ...
  output        io_lsu_exe_0_req_bits_uop_is_fence,
  output        io_lsu_exe_0_req_bits_uop_is_fencei,
  output        io_lsu_exe_0_req_bits_uop_is_amo,
  output        io_lsu_exe_0_req_bits_uop_uses_ldq,
  output        io_lsu_exe_0_req_bits_uop_uses_stq,
  output        io_lsu_exe_0_req_bits_uop_is_sys_pc2epc,
  output        io_lsu_exe_0_req_bits_uop_is_unique,
  output        io_lsu_exe_0_req_bits_uop_flush_on_commit,
  output        io_lsu_exe_0_req_bits_uop_ldst_is_rs1,
  output [5:0]  io_lsu_exe_0_req_bits_uop_ldst,
  output [5:0]  io_lsu_exe_0_req_bits_uop_lrs1,
  output [5:0]  io_lsu_exe_0_req_bits_uop_lrs2,
  output [5:0]  io_lsu_exe_0_req_bits_uop_lrs3,
  output        io_lsu_exe_0_req_bits_uop_ldst_val,
  output [1:0]  io_lsu_exe_0_req_bits_uop_dst_rtype,
  output [1:0]  io_lsu_exe_0_req_bits_uop_lrs1_rtype,
  output [1:0]  io_lsu_exe_0_req_bits_uop_lrs2_rtype,
  output        io_lsu_exe_0_req_bits_uop_frs3_en,
  output        io_lsu_exe_0_req_bits_uop_fp_val,
  output        io_lsu_exe_0_req_bits_uop_fp_single,
  output        io_lsu_exe_0_req_bits_uop_xcpt_pf_if,
  output        io_lsu_exe_0_req_bits_uop_xcpt_ae_if,
  output        io_lsu_exe_0_req_bits_uop_xcpt_ma_if,
  output        io_lsu_exe_0_req_bits_uop_bp_debug_if,
  output        io_lsu_exe_0_req_bits_uop_bp_xcpt_if,
  output [1:0]  io_lsu_exe_0_req_bits_uop_debug_fsrc,
  output [1:0]  io_lsu_exe_0_req_bits_uop_debug_tsrc,
  output [63:0] io_lsu_exe_0_req_bits_data,
  output [39:0] io_lsu_exe_0_req_bits_addr,
  output        io_lsu_exe_0_req_bits_mxcpt_valid,
  output        io_lsu_exe_0_req_bits_sfence_valid,
  output        io_lsu_exe_0_req_bits_sfence_bits_rs1,
  output        io_lsu_exe_0_req_bits_sfence_bits_rs2,
  ...
  input         io_lsu_exe_0_iresp_bits_uop_uses_stq,
  ...
  input         io_lsu_exe_0_fresp_bits_uop_uses_stq,
  ...
  output [31:0] io_lsu_exe_1_req_bits_uop_debug_inst,
  ...
  output [2:0]  io_lsu_exe_1_req_bits_uop_ctrl_imm_sel,
  output [4:0]  io_lsu_exe_1_req_bits_uop_ctrl_op_fcn,
  ...
  output        io_lsu_exe_1_req_bits_uop_ctrl_is_sta,
  output        io_lsu_exe_1_req_bits_uop_ctrl_is_std,
  output [1:0]  io_lsu_exe_1_req_bits_uop_iw_state,
  output        io_lsu_exe_1_req_bits_uop_is_br,
  output        io_lsu_exe_1_req_bits_uop_is_jalr,
  output        io_lsu_exe_1_req_bits_uop_is_jal,
  output        io_lsu_exe_1_req_bits_uop_is_sfb,
  ...
  output [4:0]  io_lsu_exe_1_req_bits_uop_stq_idx,
  output [1:0]  io_lsu_exe_1_req_bits_uop_rxq_idx,
  output [6:0]  io_lsu_exe_1_req_bits_uop_pdst,
  output [6:0]  io_lsu_exe_1_req_bits_uop_prs1,
  output [6:0]  io_lsu_exe_1_req_bits_uop_prs2,
  output [6:0]  io_lsu_exe_1_req_bits_uop_prs3,
  output [5:0]  io_lsu_exe_1_req_bits_uop_ppred,
  output        io_lsu_exe_1_req_bits_uop_prs1_busy,
  output        io_lsu_exe_1_req_bits_uop_prs2_busy,
  output        io_lsu_exe_1_req_bits_uop_prs3_busy,
  output        io_lsu_exe_1_req_bits_uop_ppred_busy,
  ...
  output        io_lsu_exe_1_req_bits_uop_is_fence,
  output        io_lsu_exe_1_req_bits_uop_is_fencei,
  output        io_lsu_exe_1_req_bits_uop_is_amo,
  output        io_lsu_exe_1_req_bits_uop_uses_ldq,
  output        io_lsu_exe_1_req_bits_uop_uses_stq,
  output        io_lsu_exe_1_req_bits_uop_is_sys_pc2epc,
  output        io_lsu_exe_1_req_bits_uop_is_unique,
  output        io_lsu_exe_1_req_bits_uop_flush_on_commit,
  output        io_lsu_exe_1_req_bits_uop_ldst_is_rs1,
  output [5:0]  io_lsu_exe_1_req_bits_uop_ldst,
  output [5:0]  io_lsu_exe_1_req_bits_uop_lrs1,
  output [5:0]  io_lsu_exe_1_req_bits_uop_lrs2,
  output [5:0]  io_lsu_exe_1_req_bits_uop_lrs3,
  output        io_lsu_exe_1_req_bits_uop_ldst_val,
  output [1:0]  io_lsu_exe_1_req_bits_uop_dst_rtype,
  output [1:0]  io_lsu_exe_1_req_bits_uop_lrs1_rtype,
  output [1:0]  io_lsu_exe_1_req_bits_uop_lrs2_rtype,
  output        io_lsu_exe_1_req_bits_uop_frs3_en,
  output        io_lsu_exe_1_req_bits_uop_fp_val,
  output        io_lsu_exe_1_req_bits_uop_fp_single,
  output        io_lsu_exe_1_req_bits_uop_xcpt_pf_if,
  output        io_lsu_exe_1_req_bits_uop_xcpt_ae_if,
  output        io_lsu_exe_1_req_bits_uop_xcpt_ma_if,
  output        io_lsu_exe_1_req_bits_uop_bp_debug_if,
  output        io_lsu_exe_1_req_bits_uop_bp_xcpt_if,
  output [1:0]  io_lsu_exe_1_req_bits_uop_debug_fsrc,
  output [1:0]  io_lsu_exe_1_req_bits_uop_debug_tsrc,
  output [63:0] io_lsu_exe_1_req_bits_data,
  output [39:0] io_lsu_exe_1_req_bits_addr,
  output        io_lsu_exe_1_req_bits_mxcpt_valid,
  output        io_lsu_exe_1_req_bits_sfence_valid,
  output        io_lsu_exe_1_req_bits_sfence_bits_rs1,
  output        io_lsu_exe_1_req_bits_sfence_bits_rs2,
  ...
  input  [6:0]  io_lsu_exe_1_iresp_bits_uop_pdst,
  input         io_lsu_exe_1_iresp_bits_uop_is_amo,
  input         io_lsu_exe_1_iresp_bits_uop_uses_stq,
  ...
  input         io_lsu_exe_1_fresp_bits_uop_uses_stq,
  ...
  output [31:0] io_lsu_dis_uops_0_bits_debug_inst,
  ...
  output [2:0]  io_lsu_dis_uops_0_bits_ctrl_imm_sel,
  output [4:0]  io_lsu_dis_uops_0_bits_ctrl_op_fcn,
  ...
  output        io_lsu_dis_uops_0_bits_ctrl_is_sta,
  output        io_lsu_dis_uops_0_bits_ctrl_is_std,
  output [1:0]  io_lsu_dis_uops_0_bits_iw_state,
  output        io_lsu_dis_uops_0_bits_iw_p1_poisoned,
  output        io_lsu_dis_uops_0_bits_iw_p2_poisoned,
  output        io_lsu_dis_uops_0_bits_is_br,
  output        io_lsu_dis_uops_0_bits_is_jalr,
  output        io_lsu_dis_uops_0_bits_is_jal,
  output        io_lsu_dis_uops_0_bits_is_sfb,
  ...
  output [4:0]  io_lsu_dis_uops_0_bits_stq_idx,
  output [1:0]  io_lsu_dis_uops_0_bits_rxq_idx,
  output [6:0]  io_lsu_dis_uops_0_bits_pdst,
  output [6:0]  io_lsu_dis_uops_0_bits_prs1,
  output [6:0]  io_lsu_dis_uops_0_bits_prs2,
  output [6:0]  io_lsu_dis_uops_0_bits_prs3,
  output        io_lsu_dis_uops_0_bits_prs1_busy,
  output        io_lsu_dis_uops_0_bits_prs2_busy,
  output        io_lsu_dis_uops_0_bits_prs3_busy,
  ...
  output        io_lsu_dis_uops_0_bits_is_fence,
  output        io_lsu_dis_uops_0_bits_is_fencei,
  output        io_lsu_dis_uops_0_bits_is_amo,
  output        io_lsu_dis_uops_0_bits_uses_ldq,
  output        io_lsu_dis_uops_0_bits_uses_stq,
  output        io_lsu_dis_uops_0_bits_is_sys_pc2epc,
  output        io_lsu_dis_uops_0_bits_is_unique,
  output        io_lsu_dis_uops_0_bits_flush_on_commit,
  output        io_lsu_dis_uops_0_bits_ldst_is_rs1,
  output [5:0]  io_lsu_dis_uops_0_bits_ldst,
  output [5:0]  io_lsu_dis_uops_0_bits_lrs1,
  output [5:0]  io_lsu_dis_uops_0_bits_lrs2,
  output [5:0]  io_lsu_dis_uops_0_bits_lrs3,
  output        io_lsu_dis_uops_0_bits_ldst_val,
  output [1:0]  io_lsu_dis_uops_0_bits_dst_rtype,
  output [1:0]  io_lsu_dis_uops_0_bits_lrs1_rtype,
  output [1:0]  io_lsu_dis_uops_0_bits_lrs2_rtype,
  output        io_lsu_dis_uops_0_bits_frs3_en,
  output        io_lsu_dis_uops_0_bits_fp_val,
  output        io_lsu_dis_uops_0_bits_fp_single,
  output        io_lsu_dis_uops_0_bits_xcpt_pf_if,
  output        io_lsu_dis_uops_0_bits_xcpt_ae_if,
  output        io_lsu_dis_uops_0_bits_xcpt_ma_if,
  output        io_lsu_dis_uops_0_bits_bp_debug_if,
  output        io_lsu_dis_uops_0_bits_bp_xcpt_if,
  output [1:0]  io_lsu_dis_uops_0_bits_debug_fsrc,
  output [1:0]  io_lsu_dis_uops_0_bits_debug_tsrc,
  output        io_lsu_dis_uops_1_valid,
  output [6:0]  io_lsu_dis_uops_1_bits_uopc,
  output [31:0] io_lsu_dis_uops_1_bits_inst,
  output [31:0] io_lsu_dis_uops_1_bits_debug_inst,
  ...
  output [2:0]  io_lsu_dis_uops_1_bits_ctrl_imm_sel,
  output [4:0]  io_lsu_dis_uops_1_bits_ctrl_op_fcn,
  ...
  output        io_lsu_dis_uops_1_bits_ctrl_is_sta,
  output        io_lsu_dis_uops_1_bits_ctrl_is_std,
  output [1:0]  io_lsu_dis_uops_1_bits_iw_state,
  output        io_lsu_dis_uops_1_bits_iw_p1_poisoned,
  output        io_lsu_dis_uops_1_bits_iw_p2_poisoned,
  output        io_lsu_dis_uops_1_bits_is_br,
  output        io_lsu_dis_uops_1_bits_is_jalr,
  output        io_lsu_dis_uops_1_bits_is_jal,
  output        io_lsu_dis_uops_1_bits_is_sfb,
  ...
  output [4:0]  io_lsu_dis_uops_1_bits_stq_idx,
  output [1:0]  io_lsu_dis_uops_1_bits_rxq_idx,
  output [6:0]  io_lsu_dis_uops_1_bits_pdst,
  output [6:0]  io_lsu_dis_uops_1_bits_prs1,
  output [6:0]  io_lsu_dis_uops_1_bits_prs2,
  output [6:0]  io_lsu_dis_uops_1_bits_prs3,
  output        io_lsu_dis_uops_1_bits_prs1_busy,
  output        io_lsu_dis_uops_1_bits_prs2_busy,
  output        io_lsu_dis_uops_1_bits_prs3_busy,
  ...
  output        io_lsu_dis_uops_1_bits_is_fence,
  output        io_lsu_dis_uops_1_bits_is_fencei,
  output        io_lsu_dis_uops_1_bits_is_amo,
  output        io_lsu_dis_uops_1_bits_uses_ldq,
  output        io_lsu_dis_uops_1_bits_uses_stq,
  output        io_lsu_dis_uops_1_bits_is_sys_pc2epc,
  output        io_lsu_dis_uops_1_bits_is_unique,
  output        io_lsu_dis_uops_1_bits_flush_on_commit,
  output        io_lsu_dis_uops_1_bits_ldst_is_rs1,
  output [5:0]  io_lsu_dis_uops_1_bits_ldst,
  output [5:0]  io_lsu_dis_uops_1_bits_lrs1,
  output [5:0]  io_lsu_dis_uops_1_bits_lrs2,
  output [5:0]  io_lsu_dis_uops_1_bits_lrs3,
  output        io_lsu_dis_uops_1_bits_ldst_val,
  output [1:0]  io_lsu_dis_uops_1_bits_dst_rtype,
  output [1:0]  io_lsu_dis_uops_1_bits_lrs1_rtype,
  output [1:0]  io_lsu_dis_uops_1_bits_lrs2_rtype,
  output        io_lsu_dis_uops_1_bits_frs3_en,
  output        io_lsu_dis_uops_1_bits_fp_val,
  output        io_lsu_dis_uops_1_bits_fp_single,
  output        io_lsu_dis_uops_1_bits_xcpt_pf_if,
  output        io_lsu_dis_uops_1_bits_xcpt_ae_if,
  output        io_lsu_dis_uops_1_bits_xcpt_ma_if,
  output        io_lsu_dis_uops_1_bits_bp_debug_if,
  output        io_lsu_dis_uops_1_bits_bp_xcpt_if,
  output [1:0]  io_lsu_dis_uops_1_bits_debug_fsrc,
  output [1:0]  io_lsu_dis_uops_1_bits_debug_tsrc,
  output        io_lsu_dis_uops_2_valid,
  output [6:0]  io_lsu_dis_uops_2_bits_uopc,
  output [31:0] io_lsu_dis_uops_2_bits_inst,
  output [31:0] io_lsu_dis_uops_2_bits_debug_inst,
  ...
  output [2:0]  io_lsu_dis_uops_2_bits_ctrl_imm_sel,
  output [4:0]  io_lsu_dis_uops_2_bits_ctrl_op_fcn,
  ...
  output        io_lsu_dis_uops_2_bits_ctrl_is_sta,
  output        io_lsu_dis_uops_2_bits_ctrl_is_std,
  output [1:0]  io_lsu_dis_uops_2_bits_iw_state,
  output        io_lsu_dis_uops_2_bits_iw_p1_poisoned,
  output        io_lsu_dis_uops_2_bits_iw_p2_poisoned,
  output        io_lsu_dis_uops_2_bits_is_br,
  output        io_lsu_dis_uops_2_bits_is_jalr,
  output        io_lsu_dis_uops_2_bits_is_jal,
  output        io_lsu_dis_uops_2_bits_is_sfb,
  ...
  output [4:0]  io_lsu_dis_uops_2_bits_stq_idx,
  output [1:0]  io_lsu_dis_uops_2_bits_rxq_idx,
  output [6:0]  io_lsu_dis_uops_2_bits_pdst,
  output [6:0]  io_lsu_dis_uops_2_bits_prs1,
  output [6:0]  io_lsu_dis_uops_2_bits_prs2,
  output [6:0]  io_lsu_dis_uops_2_bits_prs3,
  output        io_lsu_dis_uops_2_bits_prs1_busy,
  output        io_lsu_dis_uops_2_bits_prs2_busy,
  output        io_lsu_dis_uops_2_bits_prs3_busy,
  ...
  output        io_lsu_dis_uops_2_bits_is_fence,
  output        io_lsu_dis_uops_2_bits_is_fencei,
  output        io_lsu_dis_uops_2_bits_is_amo,
  output        io_lsu_dis_uops_2_bits_uses_ldq,
  output        io_lsu_dis_uops_2_bits_uses_stq,
  output        io_lsu_dis_uops_2_bits_is_sys_pc2epc,
  output        io_lsu_dis_uops_2_bits_is_unique,
  output        io_lsu_dis_uops_2_bits_flush_on_commit,
  output        io_lsu_dis_uops_2_bits_ldst_is_rs1,
  output [5:0]  io_lsu_dis_uops_2_bits_ldst,
  output [5:0]  io_lsu_dis_uops_2_bits_lrs1,
  output [5:0]  io_lsu_dis_uops_2_bits_lrs2,
  output [5:0]  io_lsu_dis_uops_2_bits_lrs3,
  output        io_lsu_dis_uops_2_bits_ldst_val,
  output [1:0]  io_lsu_dis_uops_2_bits_dst_rtype,
  output [1:0]  io_lsu_dis_uops_2_bits_lrs1_rtype,
  output [1:0]  io_lsu_dis_uops_2_bits_lrs2_rtype,
  output        io_lsu_dis_uops_2_bits_frs3_en,
  output        io_lsu_dis_uops_2_bits_fp_val,
  output        io_lsu_dis_uops_2_bits_fp_single,
  output        io_lsu_dis_uops_2_bits_xcpt_pf_if,
  output        io_lsu_dis_uops_2_bits_xcpt_ae_if,
  output        io_lsu_dis_uops_2_bits_xcpt_ma_if,
  output        io_lsu_dis_uops_2_bits_bp_debug_if,
  output        io_lsu_dis_uops_2_bits_bp_xcpt_if,
  output [1:0]  io_lsu_dis_uops_2_bits_debug_fsrc,
  output [1:0]  io_lsu_dis_uops_2_bits_debug_tsrc,
  output        io_lsu_dis_uops_3_valid,
  output [6:0]  io_lsu_dis_uops_3_bits_uopc,
  output [31:0] io_lsu_dis_uops_3_bits_inst,
  output [31:0] io_lsu_dis_uops_3_bits_debug_inst,
  ...
  output [2:0]  io_lsu_dis_uops_3_bits_ctrl_imm_sel,
  output [4:0]  io_lsu_dis_uops_3_bits_ctrl_op_fcn,
  ...
  output        io_lsu_dis_uops_3_bits_ctrl_is_sta,
  output        io_lsu_dis_uops_3_bits_ctrl_is_std,
  output [1:0]  io_lsu_dis_uops_3_bits_iw_state,
  output        io_lsu_dis_uops_3_bits_iw_p1_poisoned,
  output        io_lsu_dis_uops_3_bits_iw_p2_poisoned,
  output        io_lsu_dis_uops_3_bits_is_br,
  output        io_lsu_dis_uops_3_bits_is_jalr,
  output        io_lsu_dis_uops_3_bits_is_jal,
  output        io_lsu_dis_uops_3_bits_is_sfb,
  ...
  output [4:0]  io_lsu_dis_uops_3_bits_stq_idx,
  output [1:0]  io_lsu_dis_uops_3_bits_rxq_idx,
  output [6:0]  io_lsu_dis_uops_3_bits_pdst,
  output [6:0]  io_lsu_dis_uops_3_bits_prs1,
  output [6:0]  io_lsu_dis_uops_3_bits_prs2,
  output [6:0]  io_lsu_dis_uops_3_bits_prs3,
  output        io_lsu_dis_uops_3_bits_prs1_busy,
  output        io_lsu_dis_uops_3_bits_prs2_busy,
  output        io_lsu_dis_uops_3_bits_prs3_busy,
  ...
  output        io_lsu_dis_uops_3_bits_is_fence,
  output        io_lsu_dis_uops_3_bits_is_fencei,
  output        io_lsu_dis_uops_3_bits_is_amo,
  output        io_lsu_dis_uops_3_bits_uses_ldq,
  output        io_lsu_dis_uops_3_bits_uses_stq,
  output        io_lsu_dis_uops_3_bits_is_sys_pc2epc,
  output        io_lsu_dis_uops_3_bits_is_unique,
  output        io_lsu_dis_uops_3_bits_flush_on_commit,
  output        io_lsu_dis_uops_3_bits_ldst_is_rs1,
  output [5:0]  io_lsu_dis_uops_3_bits_ldst,
  output [5:0]  io_lsu_dis_uops_3_bits_lrs1,
  output [5:0]  io_lsu_dis_uops_3_bits_lrs2,
  output [5:0]  io_lsu_dis_uops_3_bits_lrs3,
  output        io_lsu_dis_uops_3_bits_ldst_val,
  output [1:0]  io_lsu_dis_uops_3_bits_dst_rtype,
  output [1:0]  io_lsu_dis_uops_3_bits_lrs1_rtype,
  output [1:0]  io_lsu_dis_uops_3_bits_lrs2_rtype,
  output        io_lsu_dis_uops_3_bits_frs3_en,
  output        io_lsu_dis_uops_3_bits_fp_val,
  output        io_lsu_dis_uops_3_bits_fp_single,
  output        io_lsu_dis_uops_3_bits_xcpt_pf_if,
  output        io_lsu_dis_uops_3_bits_xcpt_ae_if,
  output        io_lsu_dis_uops_3_bits_xcpt_ma_if,
  output        io_lsu_dis_uops_3_bits_bp_debug_if,
  output        io_lsu_dis_uops_3_bits_bp_xcpt_if,
  output [1:0]  io_lsu_dis_uops_3_bits_debug_fsrc,
  output [1:0]  io_lsu_dis_uops_3_bits_debug_tsrc,
  input  [4:0]  io_lsu_dis_ldq_idx_0,
  input  [4:0]  io_lsu_dis_ldq_idx_1,
  input  [4:0]  io_lsu_dis_ldq_idx_2,
  input  [4:0]  io_lsu_dis_ldq_idx_3,
  input  [4:0]  io_lsu_dis_stq_idx_0,
  input  [4:0]  io_lsu_dis_stq_idx_1,
  input  [4:0]  io_lsu_dis_stq_idx_2,
  input  [4:0]  io_lsu_dis_stq_idx_3,
  input         io_lsu_ldq_full_0,
  input         io_lsu_ldq_full_1,
  input         io_lsu_ldq_full_2,
  input         io_lsu_ldq_full_3,
  input         io_lsu_stq_full_0,
  input         io_lsu_stq_full_1,
  input         io_lsu_stq_full_2,
  input         io_lsu_stq_full_3,
  input         io_lsu_fp_stdata_ready,
  ...
  output        io_lsu_commit_valids_1,
  output        io_lsu_commit_valids_2,
  output        io_lsu_commit_valids_3,
  output        io_lsu_commit_uops_0_uses_ldq,
  output        io_lsu_commit_uops_0_uses_stq,
  output        io_lsu_commit_uops_1_uses_ldq,
  output        io_lsu_commit_uops_1_uses_stq,
  output        io_lsu_commit_uops_2_uses_ldq,
  output        io_lsu_commit_uops_2_uses_stq,
  output        io_lsu_commit_uops_3_uses_ldq,
  output        io_lsu_commit_uops_3_uses_stq,
  output        io_lsu_commit_load_at_rob_head,
  ...
  output [19:0] io_lsu_brupdate_b1_mispredict_mask,
  output [4:0]  io_lsu_brupdate_b2_uop_ldq_idx,
  output [4:0]  io_lsu_brupdate_b2_uop_stq_idx,
  ...
  wire [4:0]      _iregister_read_io_exe_reqs_0_bits_uop_ctrl_op_fcn;
  ...
  wire [4:0]      _iregister_read_io_exe_reqs_1_bits_uop_ctrl_op_fcn;
  ...
  wire [4:0]      _iregister_read_io_exe_reqs_2_bits_uop_ctrl_op_fcn;
  ...
  wire [4:0]      _iregister_read_io_exe_reqs_3_bits_uop_ctrl_op_fcn;
  ...
  wire [4:0]      _iregister_read_io_exe_reqs_4_bits_uop_ctrl_op_fcn;
  ...
  wire [4:0]      _iregister_read_io_exe_reqs_5_bits_uop_ctrl_op_fcn;
  ...
  wire            rename_stage_io_kill = REG | _GEN_7 | (|{_rob_io_flush_frontend, _b1_mispredict_mask_T_10});
  wire            _io_ifu_commit_valid_T = _rob_io_commit_valids_0 | _rob_io_commit_valids_1;
  wire [3:0][5:0] _GEN_19 = {{_rob_io_commit_uops_3_ftq_idx}, {_rob_io_commit_uops_2_ftq_idx}, {_rob_io_commit_uops_1_ftq_idx}, {_rob_io_commit_uops_0_ftq_idx}};
  ...
  wire            io_ptw_sfence_valid_0 = REG_3 ? io_ifu_sfence_REG_1_valid : io_ifu_sfence_REG_valid;
  wire            io_ptw_sfence_bits_rs1_0 = REG_3 ? io_ifu_sfence_REG_1_bits_rs1 : io_ifu_sfence_REG_bits_rs1;
  wire            io_ptw_sfence_bits_rs2_0 = REG_3 ? io_ifu_sfence_REG_1_bits_rs2 : io_ifu_sfence_REG_bits_rs2;
  wire [38:0]     io_ptw_sfence_bits_addr_0 = REG_3 ? io_ifu_sfence_REG_1_bits_addr : io_ifu_sfence_REG_bits_addr;
  ...
  wire [3:0][5:0] _GEN_20 = {{_decode_units_3_io_deq_uop_ftq_idx}, {_decode_units_2_io_deq_uop_ftq_idx}, {_decode_units_1_io_deq_uop_ftq_idx}, {_decode_units_0_io_deq_uop_ftq_idx}};
  ...
  wire            dec_stalls_0 = dec_valids_0 & ((|{dis_stalls_3 | _rob_io_commit_rollback | dec_xcpt_stall | _dec_brmask_logic_io_is_full_0, _b1_mispredict_mask_T_10}) | b2_mispredict | rename_stage_io_kill);
  wire            dec_stalls_1 = dec_stalls_0 | dec_valids_1 & ((|{dis_stalls_3 | _rob_io_commit_rollback | dec_xcpt_stall | _dec_brmask_logic_io_is_full_1, _b1_mispredict_mask_T_10}) | b2_mispredict | rename_stage_io_kill);
  wire            dec_stalls_2 = dec_stalls_1 | dec_valids_2 & ((|{dis_stalls_3 | _rob_io_commit_rollback | dec_xcpt_stall | _dec_brmask_logic_io_is_full_2, _b1_mispredict_mask_T_10}) | b2_mispredict | rename_stage_io_kill);
  ...
  wire            dec_fire_3 = dec_valids_3 & ~(dec_stalls_2 | dec_valids_3 & ((|{dis_stalls_3 | _rob_io_commit_rollback | dec_xcpt_stall | _dec_brmask_logic_io_is_full_3, _b1_mispredict_mask_T_10}) | b2_mispredict | rename_stage_io_kill));
  ...
  `ifndef SYNTHESIS
    wire _GEN_21 = _alu_exe_unit_io_iresp_valid & _rob_io_debug_wb_valids_2_T;
    wire _GEN_22 = ~reset & _GEN_21 & (|_alu_exe_unit_io_iresp_bits_uop_dst_rtype);
    wire _GEN_23 = _alu_exe_unit_1_io_iresp_valid & _rob_io_debug_wb_valids_3_T;
    wire _GEN_24 = ~reset & _GEN_23 & (|_alu_exe_unit_1_io_iresp_bits_uop_dst_rtype);
    wire _GEN_25 = _alu_exe_unit_2_io_iresp_valid & _rob_io_debug_wb_valids_4_T;
    wire _GEN_26 = ~reset & _GEN_25 & (|_alu_exe_unit_2_io_iresp_bits_uop_dst_rtype);
    wire _GEN_27 = _alu_exe_unit_3_io_iresp_valid & _rob_io_debug_wb_valids_5_T;
    wire _GEN_28 = ~reset & _GEN_27 & (|_alu_exe_unit_3_io_iresp_bits_uop_dst_rtype);
    always @(posedge clock) begin
      ...
      if (~reset & (_io_ifu_commit_valid_T | _rob_io_commit_valids_2 | _rob_io_commit_valids_3) & _rob_io_com_xcpt_valid) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed: ROB can't commit and except in same cycle!\n    at core.scala:474 assert(!(rob.io.commit.valids.reduce(_|_) && rob.io.com_xcpt.valid),\n");
        if (`STOP_COND_)
          $fatal;
      end
      if (_GEN_22) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed\n    at core.scala:823 assert(!(resp.valid && resp.bits.uop.rf_wen && resp.bits.uop.dst_rtype =/= RT_FIX))\n");
        if (`STOP_COND_)
          $fatal;
      end
      if (_GEN_24) begin
      ...
      if (~reset & _GEN_21 & _alu_exe_unit_io_iresp_bits_uop_dst_rtype == 2'h1) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed: [fppipeline] An FP writeback is being attempted to the Int Regfile.\n    at core.scala:1175 assert (!wbIsValid(RT_FLT), \"[fppipeline] An FP writeback is being attempted to the Int Regfile.\")\n");
        if (`STOP_COND_)
          $fatal;
      end
      if (~reset & _alu_exe_unit_io_iresp_valid & _alu_exe_unit_io_iresp_bits_uop_dst_rtype == 2'h2 & ~(|_alu_exe_unit_io_iresp_bits_uop_dst_rtype)) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed: [fppipeline] An Int writeback is being attempted with rf_wen disabled.\n    at core.scala:1177 assert (!(wbresp.valid &&\n");
        if (`STOP_COND_)
          $fatal;
      end
      if (_GEN_22) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed: [fppipeline] writeback being attempted to Int RF with dst != Int type exe_units(2).iresp\n    at core.scala:1182 assert (!(wbresp.valid &&\n");
        if (`STOP_COND_)
          $fatal;
      end
      if (~reset & _GEN_23 & _alu_exe_unit_1_io_iresp_bits_uop_dst_rtype == 2'h1) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed: [fppipeline] An FP writeback is being attempted to the Int Regfile.\n    at core.scala:1175 assert (!wbIsValid(RT_FLT), \"[fppipeline] An FP writeback is being attempted to the Int Regfile.\")\n");
        if (`STOP_COND_)
          $fatal;
      end
      if (~reset & _alu_exe_unit_1_io_iresp_valid & _alu_exe_unit_1_io_iresp_bits_uop_dst_rtype == 2'h2 & ~(|_alu_exe_unit_1_io_iresp_bits_uop_dst_rtype)) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed: [fppipeline] An Int writeback is being attempted with rf_wen disabled.\n    at core.scala:1177 assert (!(wbresp.valid &&\n");
        if (`STOP_COND_)
          $fatal;
      ...
      if (~reset & _GEN_25 & _alu_exe_unit_2_io_iresp_bits_uop_dst_rtype == 2'h1) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed: [fppipeline] An FP writeback is being attempted to the Int Regfile.\n    at core.scala:1175 assert (!wbIsValid(RT_FLT), \"[fppipeline] An FP writeback is being attempted to the Int Regfile.\")\n");
        if (`STOP_COND_)
          $fatal;
      end
      if (~reset & _alu_exe_unit_2_io_iresp_valid & _alu_exe_unit_2_io_iresp_bits_uop_dst_rtype == 2'h2 & ~(|_alu_exe_unit_2_io_iresp_bits_uop_dst_rtype)) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed: [fppipeline] An Int writeback is being attempted with rf_wen disabled.\n    at core.scala:1177 assert (!(wbresp.valid &&\n");
        if (`STOP_COND_)
          $fatal;
      ...
      if (~reset & _GEN_27 & _alu_exe_unit_3_io_iresp_bits_uop_dst_rtype == 2'h1) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed: [fppipeline] An FP writeback is being attempted to the Int Regfile.\n    at core.scala:1175 assert (!wbIsValid(RT_FLT), \"[fppipeline] An FP writeback is being attempted to the Int Regfile.\")\n");
        if (`STOP_COND_)
          $fatal;
      end
      if (~reset & _alu_exe_unit_3_io_iresp_valid & _alu_exe_unit_3_io_iresp_bits_uop_dst_rtype == 2'h2 & ~(|_alu_exe_unit_3_io_iresp_bits_uop_dst_rtype)) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed: [fppipeline] An Int writeback is being attempted with rf_wen disabled.\n    at core.scala:1177 assert (!(wbresp.valid &&\n");
        if (`STOP_COND_)
          $fatal;
  ...
  wire            _GEN_29 = (|{_rob_io_commit_valids_3, _rob_io_commit_valids_2, _rob_io_commit_valids_1, _rob_io_commit_valids_0}) | _csr_io_csr_stall | reset;
  ...
  wire [1:0]      _GEN_30 = {1'h0, _rob_io_commit_arch_valids_0};
  wire [1:0]      _GEN_31 = {1'h0, _rob_io_commit_arch_valids_1};
  wire [1:0]      _GEN_32 = {1'h0, _rob_io_commit_arch_valids_2};
  wire [1:0]      _GEN_33 = {1'h0, _rob_io_commit_arch_valids_3};
  wire            loads_saturating = _mem_issue_unit_io_iss_valids_0 & _mem_issue_unit_io_iss_uops_0_uses_ldq;
  wire [3:0]      _GEN_34 = {{_rename_stage_io_ren2_uops_3_is_sys_pc2epc}, {_rename_stage_io_ren2_uops_2_is_sys_pc2epc}, {_rename_stage_io_ren2_uops_1_is_sys_pc2epc}, {_rename_stage_io_ren2_uops_0_is_sys_pc2epc}};
  wire [3:0][5:0] _GEN_35 = {{_rename_stage_io_ren2_uops_3_ftq_idx}, {_rename_stage_io_ren2_uops_2_ftq_idx}, {_rename_stage_io_ren2_uops_1_ftq_idx}, {_rename_stage_io_ren2_uops_0_ftq_idx}};
  always @(posedge clock) begin
    ...
    REG_4 <= (dis_fire_0 | dis_fire_1 | dis_fire_2 | dis_fire_3) & _GEN_34[dis_fire_0 ? 2'h0 : dis_fire_1 ? 2'h1 : {1'h1, ~dis_fire_2}];
    io_ifu_commit_bits_REG <= _GEN_35[_rename_stage_io_ren2_mask_0 ? 2'h0 : _rename_stage_io_ren2_mask_1 ? 2'h1 : {1'h1, ~_rename_stage_io_ren2_mask_2}];
    ...
    csr_io_retire_REG <= {1'h0, _GEN_30 + _GEN_31} + {1'h0, _GEN_32 + _GEN_33};
    ...
    if (reset) begin
      ...
      debug_irt_reg <= debug_irt_reg + {61'h0, {1'h0, _GEN_30 + _GEN_31} + {1'h0, _GEN_32 + _GEN_33}};
      dec_finished_mask <= ~dis_stalls_3 | rename_stage_io_kill ? 4'h0 : {dec_fire_3, dec_fire_2, dec_fire_1, dec_fire_0} | dec_finished_mask;
      saturating_loads_counter <= loads_saturating ? saturating_loads_counter + 5'h1 : 5'h0;
      small_0 <= _GEN_29 ? 5'h0 : nextSmall[4:0];
      if (_GEN_29)
        large_0 <= 27'h0;	// @[generators/rocket-chip/src/main/scala/util/Counters.scala:50:31]
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        brinfos_0_uop_is_rvc = _RANDOM[7'h2][7];
        brinfos_0_uop_br_mask = {_RANDOM[7'h4][31:29], _RANDOM[7'h5][16:0]};
        brinfos_0_uop_br_tag = _RANDOM[7'h5][21:17];
        brinfos_0_uop_ftq_idx = _RANDOM[7'h5][27:22];
        brinfos_0_uop_edge_inst = _RANDOM[7'h5][28];
        brinfos_0_uop_pc_lob = {_RANDOM[7'h5][31:29], _RANDOM[7'h6][2:0]};
        brinfos_0_uop_rob_idx = _RANDOM[7'h7][10:4];
        brinfos_0_uop_ldq_idx = _RANDOM[7'h7][15:11];
        brinfos_0_uop_stq_idx = _RANDOM[7'h7][20:16];
        brinfos_0_valid = _RANDOM[7'hD][2];
        brinfos_0_mispredict = _RANDOM[7'hD][3];
        brinfos_0_taken = _RANDOM[7'hD][4];
        brinfos_0_cfi_type = _RANDOM[7'hD][7:5];
        brinfos_0_pc_sel = _RANDOM[7'hD][9:8];
        brinfos_0_target_offset = {_RANDOM[7'hE][31:18], _RANDOM[7'hF][6:0]};
        brinfos_1_uop_is_rvc = _RANDOM[7'h11][14];
        brinfos_1_uop_br_mask = _RANDOM[7'h14][23:4];
        brinfos_1_uop_br_tag = _RANDOM[7'h14][28:24];
        brinfos_1_uop_ftq_idx = {_RANDOM[7'h14][31:29], _RANDOM[7'h15][2:0]};
        brinfos_1_uop_edge_inst = _RANDOM[7'h15][3];
        brinfos_1_uop_pc_lob = _RANDOM[7'h15][9:4];
        brinfos_1_uop_rob_idx = _RANDOM[7'h16][17:11];
        brinfos_1_uop_ldq_idx = _RANDOM[7'h16][22:18];
        brinfos_1_uop_stq_idx = _RANDOM[7'h16][27:23];
        brinfos_1_valid = _RANDOM[7'h1C][9];
        brinfos_1_mispredict = _RANDOM[7'h1C][10];
        brinfos_1_taken = _RANDOM[7'h1C][11];
        brinfos_1_cfi_type = _RANDOM[7'h1C][14:12];
        brinfos_1_pc_sel = _RANDOM[7'h1C][16:15];
        brinfos_1_target_offset = {_RANDOM[7'h1D][31:25], _RANDOM[7'h1E][13:0]};
        brinfos_2_uop_is_rvc = _RANDOM[7'h20][21];
        brinfos_2_uop_br_mask = _RANDOM[7'h23][30:11];
        brinfos_2_uop_br_tag = {_RANDOM[7'h23][31], _RANDOM[7'h24][3:0]};
        brinfos_2_uop_ftq_idx = _RANDOM[7'h24][9:4];
        brinfos_2_uop_edge_inst = _RANDOM[7'h24][10];
        brinfos_2_uop_pc_lob = _RANDOM[7'h24][16:11];
        brinfos_2_uop_rob_idx = _RANDOM[7'h25][24:18];
        brinfos_2_uop_ldq_idx = _RANDOM[7'h25][29:25];
        brinfos_2_uop_stq_idx = {_RANDOM[7'h25][31:30], _RANDOM[7'h26][2:0]};
        brinfos_2_valid = _RANDOM[7'h2B][16];
        brinfos_2_mispredict = _RANDOM[7'h2B][17];
        brinfos_2_taken = _RANDOM[7'h2B][18];
        brinfos_2_cfi_type = _RANDOM[7'h2B][21:19];
        brinfos_2_pc_sel = _RANDOM[7'h2B][23:22];
        brinfos_2_target_offset = _RANDOM[7'h2D][20:0];
        brinfos_3_uop_is_rvc = _RANDOM[7'h2F][28];
        brinfos_3_uop_br_mask = {_RANDOM[7'h32][31:18], _RANDOM[7'h33][5:0]};
        brinfos_3_uop_br_tag = _RANDOM[7'h33][10:6];
        brinfos_3_uop_ftq_idx = _RANDOM[7'h33][16:11];
        brinfos_3_uop_edge_inst = _RANDOM[7'h33][17];
        brinfos_3_uop_pc_lob = _RANDOM[7'h33][23:18];
        brinfos_3_uop_rob_idx = _RANDOM[7'h34][31:25];
        brinfos_3_uop_ldq_idx = _RANDOM[7'h35][4:0];
        brinfos_3_uop_stq_idx = _RANDOM[7'h35][9:5];
        brinfos_3_valid = _RANDOM[7'h3A][23];
        brinfos_3_mispredict = _RANDOM[7'h3A][24];
        brinfos_3_taken = _RANDOM[7'h3A][25];
        brinfos_3_cfi_type = _RANDOM[7'h3A][28:26];
        brinfos_3_pc_sel = _RANDOM[7'h3A][30:29];
        brinfos_3_target_offset = _RANDOM[7'h3C][27:7];
        b2_uop_is_rvc = _RANDOM[7'h3F][3];
        b2_uop_br_mask = {_RANDOM[7'h41][31:25], _RANDOM[7'h42][12:0]};
        b2_uop_br_tag = _RANDOM[7'h42][17:13];
        b2_uop_ftq_idx = _RANDOM[7'h42][23:18];
        b2_uop_edge_inst = _RANDOM[7'h42][24];
        b2_uop_pc_lob = _RANDOM[7'h42][30:25];
        b2_uop_rob_idx = _RANDOM[7'h44][6:0];
        b2_uop_ldq_idx = _RANDOM[7'h44][11:7];
        b2_uop_stq_idx = _RANDOM[7'h44][16:12];
        b2_mispredict = _RANDOM[7'h49][31];
        b2_taken = _RANDOM[7'h4A][0];
        b2_cfi_type = _RANDOM[7'h4A][3:1];
        b2_pc_sel = _RANDOM[7'h4A][5:4];
        b2_jalr_target = {_RANDOM[7'h4A][31:6], _RANDOM[7'h4B][13:0]};
        b2_target_offset = {_RANDOM[7'h4B][31:14], _RANDOM[7'h4C][2:0]};
        b2_jalr_target_REG = {_RANDOM[7'h4C][31:3], _RANDOM[7'h4D][10:0]};
        debug_tsc_reg = {_RANDOM[7'h4D][31:11], _RANDOM[7'h4E], _RANDOM[7'h4F][10:0]};
        debug_irt_reg = {_RANDOM[7'h4F][31:11], _RANDOM[7'h50], _RANDOM[7'h51][10:0]};
        debug_brs_0 = {_RANDOM[7'h51][31:11], _RANDOM[7'h52], _RANDOM[7'h53][10:0]};
        debug_brs_1 = {_RANDOM[7'h53][31:11], _RANDOM[7'h54], _RANDOM[7'h55][10:0]};
        debug_brs_2 = {_RANDOM[7'h55][31:11], _RANDOM[7'h56], _RANDOM[7'h57][10:0]};
        debug_brs_3 = {_RANDOM[7'h57][31:11], _RANDOM[7'h58], _RANDOM[7'h59][10:0]};
        debug_jals_0 = {_RANDOM[7'h59][31:11], _RANDOM[7'h5A], _RANDOM[7'h5B][10:0]};
        debug_jals_1 = {_RANDOM[7'h5B][31:11], _RANDOM[7'h5C], _RANDOM[7'h5D][10:0]};
        debug_jals_2 = {_RANDOM[7'h5D][31:11], _RANDOM[7'h5E], _RANDOM[7'h5F][10:0]};
        debug_jals_3 = {_RANDOM[7'h5F][31:11], _RANDOM[7'h60], _RANDOM[7'h61][10:0]};
        debug_jalrs_0 = {_RANDOM[7'h61][31:11], _RANDOM[7'h62], _RANDOM[7'h63][10:0]};
        debug_jalrs_1 = {_RANDOM[7'h63][31:11], _RANDOM[7'h64], _RANDOM[7'h65][10:0]};
        debug_jalrs_2 = {_RANDOM[7'h65][31:11], _RANDOM[7'h66], _RANDOM[7'h67][10:0]};
        debug_jalrs_3 = {_RANDOM[7'h67][31:11], _RANDOM[7'h68], _RANDOM[7'h69][10:0]};
        io_ifu_flush_icache_REG = _RANDOM[7'h69][11];
        io_ifu_flush_icache_REG_1 = _RANDOM[7'h69][12];
        io_ifu_flush_icache_REG_2 = _RANDOM[7'h69][13];
        io_ifu_flush_icache_REG_3 = _RANDOM[7'h69][14];
        REG = _RANDOM[7'h69][15];
        flush_typ = _RANDOM[7'h69][18:16];
        io_ifu_redirect_pc_REG = {_RANDOM[7'h69][31:19], _RANDOM[7'h6A][26:0]};
        io_ifu_redirect_pc_REG_1 = {_RANDOM[7'h6A][31:27], _RANDOM[7'h6B], _RANDOM[7'h6C][2:0]};
        flush_pc_REG = _RANDOM[7'h6C][8:3];
        flush_pc_REG_1 = _RANDOM[7'h6C][9];
        flush_pc_next_REG = _RANDOM[7'h6C][10];
        io_ifu_redirect_ftq_idx_REG = _RANDOM[7'h6C][16:11];
        REG_1 = _RANDOM[7'h6C][17];
        io_ifu_sfence_REG_valid = _RANDOM[7'h6C][19];
        io_ifu_sfence_REG_bits_rs1 = _RANDOM[7'h6C][20];
        io_ifu_sfence_REG_bits_rs2 = _RANDOM[7'h6C][21];
        io_ifu_sfence_REG_bits_addr = {_RANDOM[7'h6C][31:22], _RANDOM[7'h6D][28:0]};
        REG_3 = _RANDOM[7'h6E][0];
        io_ifu_sfence_REG_1_valid = _RANDOM[7'h6E][1];
        io_ifu_sfence_REG_1_bits_rs1 = _RANDOM[7'h6E][2];
        io_ifu_sfence_REG_1_bits_rs2 = _RANDOM[7'h6E][3];
        io_ifu_sfence_REG_1_bits_addr = {_RANDOM[7'h6E][31:4], _RANDOM[7'h6F][10:0]};
        dec_finished_mask = _RANDOM[7'h6F][17:14];
        jmp_pc_req_valid_REG = _RANDOM[7'h6F][18];
        jmp_pc_req_bits_REG = _RANDOM[7'h6F][24:19];
        dec_brmask_logic_io_flush_pipeline_REG = _RANDOM[7'h6F][25];
        REG_4 = _RANDOM[7'h6F][26];
        io_ifu_commit_bits_REG = {_RANDOM[7'h6F][31:27], _RANDOM[7'h70][0]};
        saturating_loads_counter = _RANDOM[7'h70][5:1];
        pause_mem_REG = _RANDOM[7'h70][6];
        REG_5 = _RANDOM[7'h70][16:7];
        REG_6 = _RANDOM[7'h70][26:17];
        mem_issue_unit_io_flush_pipeline_REG = _RANDOM[7'h70][27];
        int_issue_unit_io_flush_pipeline_REG = _RANDOM[7'h70][28];
        iregister_read_io_kill_REG = _RANDOM[7'h70][31];
        csr_io_retire_REG = _RANDOM[7'h71][2:0];
        csr_io_exception_REG = _RANDOM[7'h71][3];
        csr_io_pc_REG = _RANDOM[7'h71][9:4];
        csr_io_pc_REG_1 = _RANDOM[7'h71][10];
        csr_io_cause_REG = {_RANDOM[7'h71][31:11], _RANDOM[7'h72], _RANDOM[7'h73][10:0]};
        csr_io_tval_REG = {_RANDOM[7'h73][31:11], _RANDOM[7'h74][18:0]};
        io_lsu_exception_REG = _RANDOM[7'h74][19];
        REG_7 = _RANDOM[7'h74][20];
        alu_exe_unit_io_req_bits_kill_REG = _RANDOM[7'h74][23];
        alu_exe_unit_io_req_bits_kill_REG_1 = _RANDOM[7'h74][24];
        alu_exe_unit_io_req_bits_kill_REG_2 = _RANDOM[7'h74][25];
        alu_exe_unit_io_req_bits_kill_REG_3 = _RANDOM[7'h74][26];
        small_0 = _RANDOM[7'h74][31:27];
        large_0 = _RANDOM[7'h75][26:0];
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  BranchMaskGenerationLogic dec_brmask_logic (
    ...
    .io_will_fire_3              (dec_fire_3 & (_decode_units_3_io_deq_uop_is_br & ~_decode_units_3_io_deq_uop_is_sfb | _decode_units_3_io_deq_uop_is_jalr)),
  ...
  Arbiter2_ExeUnitResp_2 ll_wbarb (
  ...
  Rob rob (
    ...
    .io_enq_uops_1_debug_inst       (_rename_stage_io_ren2_uops_1_debug_inst),
    ...
    .io_enq_uops_2_debug_inst       (_rename_stage_io_ren2_uops_2_debug_inst),
    ...
    .io_enq_uops_3_debug_inst       (_rename_stage_io_ren2_uops_3_debug_inst),
  ...
  Arbiter3_UInt6 ftq_arb (
    ...
    .io_in_2_bits  (_GEN_20[dec_xcpts_0 ? 2'h0 : dec_xcpts_1 ? 2'h1 : {1'h1, ~dec_xcpts_2}]),
    .io_out_bits   (io_ifu_get_pc_0_ftq_idx)
  );
  assign io_ifu_fetchpacket_ready = ~dis_stalls_3;
  assign io_ifu_get_pc_1_ftq_idx = b2_uop_out_ftq_idx;
  assign io_ifu_sfence_valid = io_ptw_sfence_valid_0;
  assign io_ifu_sfence_bits_rs1 = io_ptw_sfence_bits_rs1_0;
  assign io_ifu_sfence_bits_rs2 = io_ptw_sfence_bits_rs2_0;
  assign io_ifu_sfence_bits_addr = io_ptw_sfence_bits_addr_0;
  ...
  assign io_ifu_redirect_flush = rename_stage_io_kill;
  ...
  assign io_ifu_commit_bits = {34'h0, REG_4 ? io_ifu_commit_bits_REG : _rob_io_com_xcpt_valid ? _rob_io_com_xcpt_bits_ftq_idx : _GEN_19[2'h3 - (_rob_io_commit_valids_3 ? 2'h0 : _rob_io_commit_valids_2 ? 2'h1 : {1'h1, ~_rob_io_commit_valids_1})]};
