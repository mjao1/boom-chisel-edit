...
module BoomWritebackUnit(
  ...
  wire              io_release_valid_0 = ~(io_req_ready_0 | _GEN_0 | _GEN_2) & state == 3'h3 & ~(data_req_cnt[2]);
  wire              _GEN_3 = io_release_ready & io_release_valid_0;
  wire              _GEN_4 = io_req_ready_0 & io_req_valid;
  wire              _GEN_5 = io_req_ready_0 | ~_GEN_0;
  wire              _GEN_6 = io_data_req_ready & io_data_req_valid_0 & io_meta_read_ready;
  always @(posedge clock) begin
    ...
    if (_GEN_5) begin
      ...
      r1_data_req_cnt <= _GEN_6 ? data_req_cnt : 3'h0;
    ...
    if (reset) begin
      ...
      if (io_req_ready_0) begin
        ...
        else if (data_req_cnt == 3'h3 & _GEN_3)
