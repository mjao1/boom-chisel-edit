...
module FpPipeline(
  ...
  input  [31:0] io_dis_uops_2_bits_debug_inst,
  ...
  input         io_dis_uops_2_bits_is_jalr,
  input         io_dis_uops_2_bits_is_jal,
  input         io_dis_uops_2_bits_is_sfb,
  ...
  input  [6:0]  io_dis_uops_2_bits_prs1,
  input  [6:0]  io_dis_uops_2_bits_prs2,
  input  [6:0]  io_dis_uops_2_bits_prs3,
  input         io_dis_uops_2_bits_prs1_busy,
  input         io_dis_uops_2_bits_prs2_busy,
  input         io_dis_uops_2_bits_prs3_busy,
  ...
  input         io_dis_uops_2_bits_is_fencei,
  input         io_dis_uops_2_bits_is_amo,
  input         io_dis_uops_2_bits_uses_ldq,
  input         io_dis_uops_2_bits_uses_stq,
  input         io_dis_uops_2_bits_is_sys_pc2epc,
  input         io_dis_uops_2_bits_is_unique,
  input         io_dis_uops_2_bits_flush_on_commit,
  input         io_dis_uops_2_bits_ldst_is_rs1,
  input  [5:0]  io_dis_uops_2_bits_ldst,
  input  [5:0]  io_dis_uops_2_bits_lrs1,
  input  [5:0]  io_dis_uops_2_bits_lrs2,
  input  [5:0]  io_dis_uops_2_bits_lrs3,
  input         io_dis_uops_2_bits_ldst_val,
  input  [1:0]  io_dis_uops_2_bits_dst_rtype,
  input  [1:0]  io_dis_uops_2_bits_lrs1_rtype,
  input  [1:0]  io_dis_uops_2_bits_lrs2_rtype,
  input         io_dis_uops_2_bits_frs3_en,
  input         io_dis_uops_2_bits_fp_val,
  input         io_dis_uops_2_bits_fp_single,
  input         io_dis_uops_2_bits_xcpt_pf_if,
  input         io_dis_uops_2_bits_xcpt_ae_if,
  input         io_dis_uops_2_bits_xcpt_ma_if,
  input         io_dis_uops_2_bits_bp_debug_if,
  input         io_dis_uops_2_bits_bp_xcpt_if,
  input  [1:0]  io_dis_uops_2_bits_debug_fsrc,
  input  [1:0]  io_dis_uops_2_bits_debug_tsrc,
  output        io_dis_uops_3_ready,
  input         io_dis_uops_3_valid,
  input  [6:0]  io_dis_uops_3_bits_uopc,
  input  [31:0] io_dis_uops_3_bits_inst,
  input  [31:0] io_dis_uops_3_bits_debug_inst,
  ...
  input         io_dis_uops_3_bits_is_jalr,
  input         io_dis_uops_3_bits_is_jal,
  input         io_dis_uops_3_bits_is_sfb,
  ...
  input  [6:0]  io_dis_uops_3_bits_prs1,
  input  [6:0]  io_dis_uops_3_bits_prs2,
  input  [6:0]  io_dis_uops_3_bits_prs3,
  input         io_dis_uops_3_bits_prs1_busy,
  input         io_dis_uops_3_bits_prs2_busy,
  input         io_dis_uops_3_bits_prs3_busy,
  ...
  input         io_dis_uops_3_bits_is_fencei,
  input         io_dis_uops_3_bits_is_amo,
  input         io_dis_uops_3_bits_uses_ldq,
  input         io_dis_uops_3_bits_uses_stq,
  input         io_dis_uops_3_bits_is_sys_pc2epc,
  input         io_dis_uops_3_bits_is_unique,
  input         io_dis_uops_3_bits_flush_on_commit,
  input         io_dis_uops_3_bits_ldst_is_rs1,
  input  [5:0]  io_dis_uops_3_bits_ldst,
  input  [5:0]  io_dis_uops_3_bits_lrs1,
  input  [5:0]  io_dis_uops_3_bits_lrs2,
  input  [5:0]  io_dis_uops_3_bits_lrs3,
  input         io_dis_uops_3_bits_ldst_val,
  input  [1:0]  io_dis_uops_3_bits_dst_rtype,
  input  [1:0]  io_dis_uops_3_bits_lrs1_rtype,
  input  [1:0]  io_dis_uops_3_bits_lrs2_rtype,
  input         io_dis_uops_3_bits_frs3_en,
  input         io_dis_uops_3_bits_fp_val,
  input         io_dis_uops_3_bits_fp_single,
  input         io_dis_uops_3_bits_xcpt_pf_if,
  input         io_dis_uops_3_bits_xcpt_ae_if,
  input         io_dis_uops_3_bits_xcpt_ma_if,
  input         io_dis_uops_3_bits_bp_debug_if,
  input         io_dis_uops_3_bits_bp_xcpt_if,
  input  [1:0]  io_dis_uops_3_bits_debug_fsrc,
  input  [1:0]  io_dis_uops_3_bits_debug_tsrc,
  ...
  input  [1:0]  io_ll_wports_1_bits_uop_dst_rtype,
  ...
  wire [4:0]   _fregister_read_io_exe_reqs_0_bits_uop_ctrl_op_fcn;
  ...
  wire [4:0]   _fregister_read_io_exe_reqs_1_bits_uop_ctrl_op_fcn;
  ...
  wire         _io_to_sdq_valid_T = fpu_exe_unit_io_ll_iresp_ready & _fpu_exe_unit_io_ll_iresp_valid;
  assign fpu_exe_unit_io_ll_iresp_ready = io_to_sdq_ready & io_to_int_ready;
  wire         io_wakeups_2_valid_0 = _fpu_exe_unit_io_fresp_valid & _fpu_exe_unit_io_fresp_bits_uop_dst_rtype == 2'h1;
  wire         io_wakeups_3_valid_0 = _fpu_exe_unit_1_io_fresp_valid & _fpu_exe_unit_1_io_fresp_bits_uop_dst_rtype == 2'h1;
  `ifndef SYNTHESIS
    ...
    always @(posedge clock) begin
      ...
      if (_GEN_0 & _fpu_exe_unit_io_fresp_bits_uop_dst_rtype == 2'h2) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_1 & _fpu_exe_unit_1_io_fresp_bits_uop_dst_rtype == 2'h2) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed: rf_wen must be high here\n    at fp-pipeline.scala:209 assert(eu.io.fresp.bits.uop.rf_wen, \"rf_wen must be high here\")\n");
        if (`STOP_COND_)
          $fatal;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        REG = _RANDOM[3'h0][9:0];
        fregfile_io_write_ports_0_REG_valid = _RANDOM[3'h0][10];
        fregfile_io_write_ports_0_REG_bits_addr = _RANDOM[3'h0][17:11];
        fregfile_io_write_ports_0_REG_bits_data = {_RANDOM[3'h0][31:18], _RANDOM[3'h1], _RANDOM[3'h2][18:0]};
        fregfile_io_write_ports_1_REG_valid = _RANDOM[3'h2][19];
        fregfile_io_write_ports_1_REG_bits_addr = _RANDOM[3'h2][26:20];
        fregfile_io_write_ports_1_bits_data_REG = {_RANDOM[3'h4][31:28], _RANDOM[3'h5], _RANDOM[3'h6][28:0]};
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  FPUExeUnit fpu_exe_unit (
    ...
    .io_ll_iresp_ready                     (fpu_exe_unit_io_ll_iresp_ready),
  ...
  IssueUnitCollapsing fp_issue_unit (
    ...
    .io_wakeup_ports_2_valid            (io_wakeups_2_valid_0),
    .io_wakeup_ports_2_bits_pdst        (_fpu_exe_unit_io_fresp_bits_uop_pdst),
    .io_wakeup_ports_3_valid            (io_wakeups_3_valid_0),
  ...
  RegisterFileSynthesizable fregfile (
    ...
    .io_write_ports_2_valid     (_fpu_exe_unit_io_fresp_valid & _fpu_exe_unit_io_fresp_bits_uop_dst_rtype != 2'h2),
    ...
    .io_write_ports_3_valid     (_fpu_exe_unit_1_io_fresp_valid & _fpu_exe_unit_1_io_fresp_bits_uop_dst_rtype != 2'h2),
  ...
  assign io_to_sdq_valid = _io_to_sdq_valid_T & _fpu_exe_unit_io_ll_iresp_bits_uop_uopc == 7'h2;
  ...
  assign io_to_int_valid = _io_to_sdq_valid_T & _fpu_exe_unit_io_ll_iresp_bits_uop_uopc != 7'h2;
  ...
  assign io_wakeups_2_valid = io_wakeups_2_valid_0;
  ...
  assign io_wakeups_3_valid = io_wakeups_3_valid_0;
