...
module BoomMSHR(
  ...
  wire             _GEN_22 = _io_probe_rdy_T_4 | _io_probe_rdy_T_8 | _GEN_6 | _GEN_7 | _GEN_8 | _GEN_9 | _GEN_10 | _GEN_11 | _GEN_21;
  wire             _GEN_23 = _io_probe_rdy_T_2 | _io_probe_rdy_T_3 | _GEN_22;
  assign io_req_pri_rdy_0 = ~(|state) | ~_GEN_23 & _io_way_valid_T_1;
  wire             _GEN_24 = io_req_sec_val & ~io_req_sec_rdy_0 | io_clear_prefetch;
  ...
  `ifndef SYNTHESIS
    wire _GEN_25 = ~(|state) & _rpq_io_enq_valid_T;
    wire _GEN_26 = (|state) & state != 5'h1;
    wire _GEN_27 = _GEN_26 & state != 5'h2 & state != 5'h3 & state != 5'h4 & state != 5'h5 & state != 5'h6 & state != 5'h7 & state != 5'h9 & state != 5'hA & state != 5'hB;
    wire _GEN_28 = _GEN_27 & state != 5'hC & state != 5'hD & state != 5'hE & state != 5'hF & _io_way_valid_T_1 & ~_GEN_24 & ~_rpq_io_enq_valid_T_1 & _rpq_io_enq_valid_T;
    always @(posedge clock) begin
      ...
      if (_GEN_25 & ~reset & ~_rpq_io_enq_ready) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed\n    at mshrs.scala:194 assert(rpq.io.enq.ready)\n");
        if (`STOP_COND_)
          $fatal;
      end
      if (_GEN_25 & io_req_tag_match & state_is_hit & ~reset & ~(_state_T_37 | _state_T_38 | _state_T_40 | _state_T_42 | _state_T_43 | _state_T_44 | _state_T_45 | _state_T_49 | _state_T_50 | _state_T_51 | _state_T_52 | _state_T_53)) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed\n    at mshrs.scala:201 assert(isWrite(io.req.uop.mem_cmd))\n");
        if (`STOP_COND_)
          $fatal;
      end
      if (_GEN_26 & refill_done & ~reset & ~grant_had_data & req_needs_wb) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed\n    at mshrs.scala:251 assert(!(!grant_had_data && req_needs_wb))\n");
        if (`STOP_COND_)
          $fatal;
      end
      if (_GEN_27 & _GEN_17 & ~reset & ~(_r_T_64 == 4'h3 | _r_T_64 == 4'h2 | _r_T_64 == 4'h1 | _r_T_64 == 4'h7 | _r_T_64 == 4'h6 | (&_r_T_64) | _r_T_64 == 4'hE)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_28 & ~reset & ~_rpq_io_enq_ready) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed\n    at mshrs.scala:194 assert(rpq.io.enq.ready)\n");
        if (`STOP_COND_)
          $fatal;
      end
      if (_GEN_28 & io_req_tag_match & state_is_hit_1 & ~reset & ~(_state_T_37 | _state_T_38 | _state_T_40 | _state_T_42 | _state_T_43 | _state_T_44 | _state_T_45 | _state_T_49 | _state_T_50 | _state_T_51 | _state_T_52 | _state_T_53)) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed\n    at mshrs.scala:201 assert(isWrite(io.req.uop.mem_cmd))\n");
        if (`STOP_COND_)
          $fatal;
  ...
  wire [15:0][1:0] _GEN_29 = {{2'h3}, {2'h3}, {2'h2}, {_r_T_91}, {_r_T_91}, {_r_T_91}, {_r_T_91}, {_r_T_91}, {2'h3}, {2'h2}, {2'h2}, {2'h1}, {2'h3}, {2'h2}, {2'h1}, {2'h0}};	// @[generators/rocket-chip/src/main/scala/util/Misc.scala:35:36, :49:20]
  ...
  wire [15:0][1:0] _GEN_30 = {{2'h3}, {2'h3}, {2'h2}, {_state_r_T_86}, {_state_r_T_86}, {_state_r_T_86}, {_state_r_T_86}, {_state_r_T_86}, {2'h3}, {2'h2}, {2'h2}, {2'h1}, {2'h3}, {2'h2}, {2'h1}, {2'h0}};	// @[generators/rocket-chip/src/main/scala/util/Misc.scala:35:36, :49:20]
  ...
  wire [15:0][1:0] _GEN_31 = {{2'h3}, {2'h3}, {2'h2}, {_r_T_150}, {_r_T_150}, {_r_T_150}, {_r_T_150}, {_r_T_150}, {2'h3}, {2'h2}, {2'h2}, {2'h1}, {2'h3}, {2'h2}, {2'h1}, {2'h0}};	// @[generators/rocket-chip/src/main/scala/util/Misc.scala:35:36, :49:20]
  ...
  wire [15:0][1:0] _GEN_32 = {{2'h3}, {2'h3}, {2'h2}, {_state_r_T_27}, {_state_r_T_27}, {_state_r_T_27}, {_state_r_T_27}, {_state_r_T_27}, {2'h3}, {2'h2}, {2'h2}, {2'h1}, {2'h3}, {2'h2}, {2'h1}, {2'h0}};	// @[generators/rocket-chip/src/main/scala/util/Misc.scala:35:36, :49:20]
  ...
  wire [15:0][1:0] _GEN_33 = {{2'h3}, {2'h3}, {2'h2}, {_r2_T_27}, {_r2_T_27}, {_r2_T_27}, {_r2_T_27}, {_r2_T_27}, {2'h3}, {2'h2}, {2'h2}, {2'h1}, {2'h3}, {2'h2}, {2'h1}, {2'h0}};	// @[generators/rocket-chip/src/main/scala/util/Misc.scala:35:36, :49:20]
  wire [15:0][1:0] _GEN_34 = {{2'h3}, {2'h3}, {2'h2}, {_r1_T_27}, {_r1_T_27}, {_r1_T_27}, {_r1_T_27}, {_r1_T_27}, {2'h3}, {2'h2}, {2'h2}, {2'h1}, {2'h3}, {2'h2}, {2'h1}, {2'h0}};	// @[generators/rocket-chip/src/main/scala/util/Misc.scala:35:36, :49:20]
  wire             _GEN_35 = _rpq_io_enq_valid_T_1 & (_r1_T == 4'h3 | _r1_T == 4'h2 | _r1_T == 4'h1 | _r1_T == 4'h7 | _r1_T == 4'h6 | (&_r1_T) | _r1_T == 4'hE) & (_r2_T == 4'h3 | _r2_T == 4'h2 | _r2_T == 4'h1 | _r2_T == 4'h7 | _r2_T == 4'h6 | (&_r2_T) | _r2_T == 4'hE);
  ...
  wire             _GEN_36 = io_meta_write_ready & io_meta_write_valid_0;
  wire             _GEN_37 = _rpq_io_enq_valid_T_1 & (&dirties_cat);
  wire             _GEN_38 = _rpq_io_enq_ready & rpq_io_enq_valid;
  wire             _GEN_39 = io_refill_ready & io_refill_valid_0;
  wire             _GEN_40 = io_mem_finish_ready & io_mem_finish_valid_0 | ~grantack_valid;
  wire             _GEN_41 = _GEN_24 | _rpq_io_enq_valid_T_1;
  wire             _GEN_42 = _GEN_23 | ~_io_way_valid_T_1 | _GEN_41 | ~_rpq_io_enq_valid_T;
  wire [1:0]       dirtier_coh_state = (&dirties_cat) ? _GEN_33[_r2_T] : _GEN_34[_r1_T];	// @[generators/rocket-chip/src/main/scala/tilelink/Metadata.scala:29:18, :58:19, :106:42, :107:33, generators/rocket-chip/src/main/scala/util/Misc.scala:35:36, :49:20]
  always @(posedge clock) begin
    if (reset) begin
      state <= 5'h0;
      req_needs_wb <= 1'h0;
      ...
      if (|state) begin
        if (_io_probe_rdy_T_2) begin	// @[generators/rocket-chip/src/main/scala/util/package.scala:16:47]
          ...
          if (_GEN_16) begin
            ...
            if (_GEN_17)
              new_coh_state <= _GEN_29[_r_T_64];
            else if (_GEN_35)
              new_coh_state <= dirtier_coh_state;
          end
          else if (_GEN_20 | ~_io_way_valid_T_1 | _GEN_24) begin
            if (_GEN_35)
              new_coh_state <= dirtier_coh_state;
          end
          else if (_rpq_io_enq_valid_T_1)
            new_coh_state <= is_hit_1 ? _GEN_31[_r_T_123] : 2'h0;
          else if (_rpq_io_enq_valid_T)
            new_coh_state <= io_req_tag_match ? (state_is_hit_1 ? _GEN_30[_state_r_T_59] : io_req_old_meta_coh_state) : 2'h0;
          else if (_GEN_35)
            new_coh_state <= dirtier_coh_state;
        end
        if (_GEN_42) begin
        ...
        req_needs_wb <= &io_req_old_meta_coh_state;
        new_coh_state <= io_req_tag_match ? (state_is_hit ? _GEN_32[_state_r_T] : io_req_old_meta_coh_state) : 2'h0;
      end
      else if (_GEN_35)
        new_coh_state <= dirtier_coh_state;
    ...
    if ((|state) ? ~_GEN_23 & _io_way_valid_T_1 & ~_GEN_41 & _rpq_io_enq_valid_T | _GEN_37 : _rpq_io_enq_valid_T | _GEN_37)
    ...
    if (|state) begin
      ...
      if (~_io_probe_rdy_T_2) begin	// @[generators/rocket-chip/src/main/scala/util/package.scala:16:47]
        if (_io_probe_rdy_T_3) begin	// @[generators/rocket-chip/src/main/scala/util/package.scala:16:47]
          ...
          grantack_valid <= _sec_rdy_T_5 ? ~_GEN_40 & grantack_valid : (_sec_rdy_T_6 | ~_io_way_valid_T_1 | _GEN_41 | ~_rpq_io_enq_valid_T) & grantack_valid;
      end
      if (~_GEN_13) begin
        if (_GEN_11) begin
          if (_GEN_39)	// @[src/main/scala/chisel3/util/Decoupled.scala:51:35]
            refill_ctr <= refill_ctr + 2'h1;
        end
        else if (_GEN_21 | ~_io_way_valid_T_1 | _GEN_41 | ~_rpq_io_enq_valid_T) begin
        end
        else
          refill_ctr <= 2'h0;
      end
    ...
    grant_had_data <= (|state) & (_io_probe_rdy_T_2 ? grant_had_data : _io_probe_rdy_T_3 ? (_GEN_0 ? io_mem_grant_bits_opcode[0] : grant_had_data) : (_GEN_22 | ~_io_way_valid_T_1 | _GEN_41 | ~_rpq_io_enq_valid_T) & grant_had_data);
    if (~_GEN_2)
      finish_to_prefetch <= _io_probe_rdy_T_4 ? ~_GEN_3 & _GEN_4 & ~_GEN_38 | finish_to_prefetch : (_io_probe_rdy_T_8 | _GEN_6 | _GEN_7 | _GEN_8 | _GEN_18 | ~(_sec_rdy_T_4 & _GEN_36)) & finish_to_prefetch;
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_needs_wb = _RANDOM[5'h11][20];
        new_coh_state = _RANDOM[5'h11][22:21];
        r_counter = _RANDOM[5'h11][30:23];
        grantack_valid = _RANDOM[5'h11][31];
        grantack_bits_sink = _RANDOM[5'h12][3:0];
        refill_ctr = _RANDOM[5'h12][5:4];
        commit_line = _RANDOM[5'h12][6];
        grant_had_data = _RANDOM[5'h12][7];
        finish_to_prefetch = _RANDOM[5'h12][8];
        meta_hazard = _RANDOM[5'h12][10:9];
      `endif // RANDOMIZE_REG_INIT
    end // initial
