...
module RenameFreeList(
  ...
  `ifndef SYNTHESIS
    wire [127:0] io_debug_freelist = free_list | allocs_0 & {128{r_valid}} | allocs_1 & {128{r_valid_1}} | allocs_2 & {128{r_valid_2}} | allocs_3 & {128{r_valid_3}};
    wire [7:0]   _GEN_128 =
      {1'h0,
    ...
    always @(posedge clock) begin
      ...
      if (~reset & ~(~io_debug_pipeline_empty | _GEN_128 > 8'h5F)) begin
        if (`ASSERT_VERBOSE_COND_)
  ...
  wire               _list_req_T_1 = io_ren_br_tags_0_bits == 5'h0;
  wire               _list_req_T_3 = io_ren_br_tags_1_bits == 5'h0;
  wire               _list_req_T_5 = io_ren_br_tags_2_bits == 5'h0;
  wire               _list_req_T_10 = io_ren_br_tags_0_bits == 5'h1;
  wire               _list_req_T_12 = io_ren_br_tags_1_bits == 5'h1;
  wire               _list_req_T_14 = io_ren_br_tags_2_bits == 5'h1;
  wire               _list_req_T_19 = io_ren_br_tags_0_bits == 5'h2;
  wire               _list_req_T_21 = io_ren_br_tags_1_bits == 5'h2;
  wire               _list_req_T_23 = io_ren_br_tags_2_bits == 5'h2;
  wire               _list_req_T_28 = io_ren_br_tags_0_bits == 5'h3;
  wire               _list_req_T_30 = io_ren_br_tags_1_bits == 5'h3;
  wire               _list_req_T_32 = io_ren_br_tags_2_bits == 5'h3;
  wire               _list_req_T_37 = io_ren_br_tags_0_bits == 5'h4;
  wire               _list_req_T_39 = io_ren_br_tags_1_bits == 5'h4;
  wire               _list_req_T_41 = io_ren_br_tags_2_bits == 5'h4;
  wire               _list_req_T_46 = io_ren_br_tags_0_bits == 5'h5;
  wire               _list_req_T_48 = io_ren_br_tags_1_bits == 5'h5;
  wire               _list_req_T_50 = io_ren_br_tags_2_bits == 5'h5;
  wire               _list_req_T_55 = io_ren_br_tags_0_bits == 5'h6;
  wire               _list_req_T_57 = io_ren_br_tags_1_bits == 5'h6;
  wire               _list_req_T_59 = io_ren_br_tags_2_bits == 5'h6;
  wire               _list_req_T_64 = io_ren_br_tags_0_bits == 5'h7;
  wire               _list_req_T_66 = io_ren_br_tags_1_bits == 5'h7;
  wire               _list_req_T_68 = io_ren_br_tags_2_bits == 5'h7;
  wire               _list_req_T_73 = io_ren_br_tags_0_bits == 5'h8;
  wire               _list_req_T_75 = io_ren_br_tags_1_bits == 5'h8;
  wire               _list_req_T_77 = io_ren_br_tags_2_bits == 5'h8;
  wire               _list_req_T_82 = io_ren_br_tags_0_bits == 5'h9;
  wire               _list_req_T_84 = io_ren_br_tags_1_bits == 5'h9;
  wire               _list_req_T_86 = io_ren_br_tags_2_bits == 5'h9;
  wire               _list_req_T_91 = io_ren_br_tags_0_bits == 5'hA;
  wire               _list_req_T_93 = io_ren_br_tags_1_bits == 5'hA;
  wire               _list_req_T_95 = io_ren_br_tags_2_bits == 5'hA;
  wire               _list_req_T_100 = io_ren_br_tags_0_bits == 5'hB;
  wire               _list_req_T_102 = io_ren_br_tags_1_bits == 5'hB;
  wire               _list_req_T_104 = io_ren_br_tags_2_bits == 5'hB;
  wire               _list_req_T_109 = io_ren_br_tags_0_bits == 5'hC;
  wire               _list_req_T_111 = io_ren_br_tags_1_bits == 5'hC;
  wire               _list_req_T_113 = io_ren_br_tags_2_bits == 5'hC;
  wire               _list_req_T_118 = io_ren_br_tags_0_bits == 5'hD;
  wire               _list_req_T_120 = io_ren_br_tags_1_bits == 5'hD;
  wire               _list_req_T_122 = io_ren_br_tags_2_bits == 5'hD;
  wire               _list_req_T_127 = io_ren_br_tags_0_bits == 5'hE;
  wire               _list_req_T_129 = io_ren_br_tags_1_bits == 5'hE;
  wire               _list_req_T_131 = io_ren_br_tags_2_bits == 5'hE;
  wire               _list_req_T_136 = io_ren_br_tags_0_bits == 5'hF;
  wire               _list_req_T_138 = io_ren_br_tags_1_bits == 5'hF;
  wire               _list_req_T_140 = io_ren_br_tags_2_bits == 5'hF;
  wire               _list_req_T_145 = io_ren_br_tags_0_bits == 5'h10;
  wire               _list_req_T_147 = io_ren_br_tags_1_bits == 5'h10;
  wire               _list_req_T_149 = io_ren_br_tags_2_bits == 5'h10;
  wire               _list_req_T_154 = io_ren_br_tags_0_bits == 5'h11;
  wire               _list_req_T_156 = io_ren_br_tags_1_bits == 5'h11;
  wire               _list_req_T_158 = io_ren_br_tags_2_bits == 5'h11;
  wire               _list_req_T_163 = io_ren_br_tags_0_bits == 5'h12;
  wire               _list_req_T_165 = io_ren_br_tags_1_bits == 5'h12;
  wire               _list_req_T_167 = io_ren_br_tags_2_bits == 5'h12;
  wire               _list_req_T_172 = io_ren_br_tags_0_bits == 5'h13;
  wire               _list_req_T_174 = io_ren_br_tags_1_bits == 5'h13;
  wire               _list_req_T_176 = io_ren_br_tags_2_bits == 5'h13;
  always @(posedge clock) begin
    if (reset) begin
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        free_list = {_RANDOM[7'h0], _RANDOM[7'h1], _RANDOM[7'h2], _RANDOM[7'h3]};
        br_alloc_lists_0 = {_RANDOM[7'h4], _RANDOM[7'h5], _RANDOM[7'h6], _RANDOM[7'h7]};
        br_alloc_lists_1 = {_RANDOM[7'h8], _RANDOM[7'h9], _RANDOM[7'hA], _RANDOM[7'hB]};
        br_alloc_lists_2 = {_RANDOM[7'hC], _RANDOM[7'hD], _RANDOM[7'hE], _RANDOM[7'hF]};
        br_alloc_lists_3 = {_RANDOM[7'h10], _RANDOM[7'h11], _RANDOM[7'h12], _RANDOM[7'h13]};
        br_alloc_lists_4 = {_RANDOM[7'h14], _RANDOM[7'h15], _RANDOM[7'h16], _RANDOM[7'h17]};
        br_alloc_lists_5 = {_RANDOM[7'h18], _RANDOM[7'h19], _RANDOM[7'h1A], _RANDOM[7'h1B]};
        br_alloc_lists_6 = {_RANDOM[7'h1C], _RANDOM[7'h1D], _RANDOM[7'h1E], _RANDOM[7'h1F]};
        br_alloc_lists_7 = {_RANDOM[7'h20], _RANDOM[7'h21], _RANDOM[7'h22], _RANDOM[7'h23]};
        br_alloc_lists_8 = {_RANDOM[7'h24], _RANDOM[7'h25], _RANDOM[7'h26], _RANDOM[7'h27]};
        br_alloc_lists_9 = {_RANDOM[7'h28], _RANDOM[7'h29], _RANDOM[7'h2A], _RANDOM[7'h2B]};
        br_alloc_lists_10 = {_RANDOM[7'h2C], _RANDOM[7'h2D], _RANDOM[7'h2E], _RANDOM[7'h2F]};
        br_alloc_lists_11 = {_RANDOM[7'h30], _RANDOM[7'h31], _RANDOM[7'h32], _RANDOM[7'h33]};
        br_alloc_lists_12 = {_RANDOM[7'h34], _RANDOM[7'h35], _RANDOM[7'h36], _RANDOM[7'h37]};
        br_alloc_lists_13 = {_RANDOM[7'h38], _RANDOM[7'h39], _RANDOM[7'h3A], _RANDOM[7'h3B]};
        br_alloc_lists_14 = {_RANDOM[7'h3C], _RANDOM[7'h3D], _RANDOM[7'h3E], _RANDOM[7'h3F]};
        br_alloc_lists_15 = {_RANDOM[7'h40], _RANDOM[7'h41], _RANDOM[7'h42], _RANDOM[7'h43]};
        br_alloc_lists_16 = {_RANDOM[7'h44], _RANDOM[7'h45], _RANDOM[7'h46], _RANDOM[7'h47]};
        br_alloc_lists_17 = {_RANDOM[7'h48], _RANDOM[7'h49], _RANDOM[7'h4A], _RANDOM[7'h4B]};
        br_alloc_lists_18 = {_RANDOM[7'h4C], _RANDOM[7'h4D], _RANDOM[7'h4E], _RANDOM[7'h4F]};
        br_alloc_lists_19 = {_RANDOM[7'h50], _RANDOM[7'h51], _RANDOM[7'h52], _RANDOM[7'h53]};
        r_valid = _RANDOM[7'h54][0];
        r_sel = _RANDOM[7'h54][7:1];
        r_valid_1 = _RANDOM[7'h54][8];
        r_sel_1 = _RANDOM[7'h54][15:9];
        r_valid_2 = _RANDOM[7'h54][16];
        r_sel_2 = _RANDOM[7'h54][23:17];
        r_valid_3 = _RANDOM[7'h54][24];
        r_sel_3 = _RANDOM[7'h54][31:25];
      `endif // RANDOMIZE_REG_INIT
    end // initial
