...
module FetchBuffer(
  ...
  input         io_enq_bits_edge_inst_1,
  input  [31:0] io_enq_bits_insts_0,
  input  [31:0] io_enq_bits_insts_1,
  input  [31:0] io_enq_bits_insts_2,
  input  [31:0] io_enq_bits_insts_3,
  input  [31:0] io_enq_bits_insts_4,
  input  [31:0] io_enq_bits_insts_5,
  input  [31:0] io_enq_bits_insts_6,
  input  [31:0] io_enq_bits_insts_7,
  ...
  input  [31:0] io_enq_bits_exp_insts_4,
  input  [31:0] io_enq_bits_exp_insts_5,
  input  [31:0] io_enq_bits_exp_insts_6,
  input  [31:0] io_enq_bits_exp_insts_7,
  ...
  input         io_enq_bits_shadowed_mask_4,
  input         io_enq_bits_shadowed_mask_5,
  input         io_enq_bits_shadowed_mask_6,
  input         io_enq_bits_shadowed_mask_7,
  ...
  input         io_enq_bits_bp_debug_if_oh_4,
  input         io_enq_bits_bp_debug_if_oh_5,
  input         io_enq_bits_bp_debug_if_oh_6,
  input         io_enq_bits_bp_debug_if_oh_7,
  ...
  input         io_enq_bits_bp_xcpt_if_oh_4,
  input         io_enq_bits_bp_xcpt_if_oh_5,
  input         io_enq_bits_bp_xcpt_if_oh_6,
  input         io_enq_bits_bp_xcpt_if_oh_7,
  ...
  output [31:0] io_deq_bits_uops_2_bits_debug_inst,
  ...
  output        io_deq_bits_uops_2_bits_xcpt_ae_if,
  output        io_deq_bits_uops_2_bits_bp_debug_if,
  output        io_deq_bits_uops_2_bits_bp_xcpt_if,
  output [1:0]  io_deq_bits_uops_2_bits_debug_fsrc,
  output        io_deq_bits_uops_3_valid,
  output [31:0] io_deq_bits_uops_3_bits_inst,
  output [31:0] io_deq_bits_uops_3_bits_debug_inst,
  ...
  output        io_deq_bits_uops_3_bits_xcpt_ae_if,
  output        io_deq_bits_uops_3_bits_bp_debug_if,
  output        io_deq_bits_uops_3_bits_bp_xcpt_if,
  ...
  wire [3:0]  _deq_valids_T_10 = slot_will_hit_tail | {slot_will_hit_tail[0] | _GEN[1], _GEN[0], slot_will_hit_tail[0], 1'h0};
  ...
  wire        _GEN_107 = do_enq & in_mask_3;
  ...
  wire        _GEN_140 = do_enq & in_mask_4;
  ...
  wire        _GEN_173 = do_enq & in_mask_5;
  ...
  wire        _GEN_206 = do_enq & in_mask_6;
  ...
  wire        _GEN_239 = do_enq & in_mask_7;
  ...
  always @(posedge clock) begin
    ...
    if (reset) begin
      ...
      maybe_full <= ~(io_clear | do_deq) & (do_enq & (in_mask_0 | in_mask_1 | in_mask_2 | in_mask_3 | in_mask_4 | in_mask_5 | in_mask_6 | in_mask_7) | maybe_full);
    end
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        fb_uop_ram_0_inst = {_RANDOM[9'h0][31:7], _RANDOM[9'h1][6:0]};
        fb_uop_ram_0_debug_inst = {_RANDOM[9'h1][31:7], _RANDOM[9'h2][6:0]};
        fb_uop_ram_0_is_rvc = _RANDOM[9'h2][7];
        fb_uop_ram_0_debug_pc = {_RANDOM[9'h2][31:8], _RANDOM[9'h3][15:0]};
        fb_uop_ram_0_is_sfb = _RANDOM[9'h4][28];
        fb_uop_ram_0_ftq_idx = _RANDOM[9'h5][27:22];
        fb_uop_ram_0_edge_inst = _RANDOM[9'h5][28];
        fb_uop_ram_0_pc_lob = {_RANDOM[9'h5][31:29], _RANDOM[9'h6][2:0]};
        fb_uop_ram_0_taken = _RANDOM[9'h6][3];
        fb_uop_ram_0_xcpt_pf_if = _RANDOM[9'hC][25];
        fb_uop_ram_0_xcpt_ae_if = _RANDOM[9'hC][26];
        fb_uop_ram_0_bp_debug_if = _RANDOM[9'hC][28];
        fb_uop_ram_0_bp_xcpt_if = _RANDOM[9'hC][29];
        fb_uop_ram_0_debug_fsrc = _RANDOM[9'hC][31:30];
        fb_uop_ram_1_inst = {_RANDOM[9'hD][31:9], _RANDOM[9'hE][8:0]};
        fb_uop_ram_1_debug_inst = {_RANDOM[9'hE][31:9], _RANDOM[9'hF][8:0]};
        fb_uop_ram_1_is_rvc = _RANDOM[9'hF][9];
        fb_uop_ram_1_debug_pc = {_RANDOM[9'hF][31:10], _RANDOM[9'h10][17:0]};
        fb_uop_ram_1_is_sfb = _RANDOM[9'h11][30];
        fb_uop_ram_1_ftq_idx = _RANDOM[9'h12][29:24];
        fb_uop_ram_1_edge_inst = _RANDOM[9'h12][30];
        fb_uop_ram_1_pc_lob = {_RANDOM[9'h12][31], _RANDOM[9'h13][4:0]};
        fb_uop_ram_1_taken = _RANDOM[9'h13][5];
        fb_uop_ram_1_xcpt_pf_if = _RANDOM[9'h19][27];
        fb_uop_ram_1_xcpt_ae_if = _RANDOM[9'h19][28];
        fb_uop_ram_1_bp_debug_if = _RANDOM[9'h19][30];
        fb_uop_ram_1_bp_xcpt_if = _RANDOM[9'h19][31];
        fb_uop_ram_1_debug_fsrc = _RANDOM[9'h1A][1:0];
        fb_uop_ram_2_inst = {_RANDOM[9'h1A][31:11], _RANDOM[9'h1B][10:0]};
        fb_uop_ram_2_debug_inst = {_RANDOM[9'h1B][31:11], _RANDOM[9'h1C][10:0]};
        fb_uop_ram_2_is_rvc = _RANDOM[9'h1C][11];
        fb_uop_ram_2_debug_pc = {_RANDOM[9'h1C][31:12], _RANDOM[9'h1D][19:0]};
        fb_uop_ram_2_is_sfb = _RANDOM[9'h1F][0];
        fb_uop_ram_2_ftq_idx = _RANDOM[9'h1F][31:26];
        fb_uop_ram_2_edge_inst = _RANDOM[9'h20][0];
        fb_uop_ram_2_pc_lob = _RANDOM[9'h20][6:1];
        fb_uop_ram_2_taken = _RANDOM[9'h20][7];
        fb_uop_ram_2_xcpt_pf_if = _RANDOM[9'h26][29];
        fb_uop_ram_2_xcpt_ae_if = _RANDOM[9'h26][30];
        fb_uop_ram_2_bp_debug_if = _RANDOM[9'h27][0];
        fb_uop_ram_2_bp_xcpt_if = _RANDOM[9'h27][1];
        fb_uop_ram_2_debug_fsrc = _RANDOM[9'h27][3:2];
        fb_uop_ram_3_inst = {_RANDOM[9'h27][31:13], _RANDOM[9'h28][12:0]};
        fb_uop_ram_3_debug_inst = {_RANDOM[9'h28][31:13], _RANDOM[9'h29][12:0]};
        fb_uop_ram_3_is_rvc = _RANDOM[9'h29][13];
        fb_uop_ram_3_debug_pc = {_RANDOM[9'h29][31:14], _RANDOM[9'h2A][21:0]};
        fb_uop_ram_3_is_sfb = _RANDOM[9'h2C][2];
        fb_uop_ram_3_ftq_idx = {_RANDOM[9'h2C][31:28], _RANDOM[9'h2D][1:0]};
        fb_uop_ram_3_edge_inst = _RANDOM[9'h2D][2];
        fb_uop_ram_3_pc_lob = _RANDOM[9'h2D][8:3];
        fb_uop_ram_3_taken = _RANDOM[9'h2D][9];
        fb_uop_ram_3_xcpt_pf_if = _RANDOM[9'h33][31];
        fb_uop_ram_3_xcpt_ae_if = _RANDOM[9'h34][0];
        fb_uop_ram_3_bp_debug_if = _RANDOM[9'h34][2];
        fb_uop_ram_3_bp_xcpt_if = _RANDOM[9'h34][3];
        fb_uop_ram_3_debug_fsrc = _RANDOM[9'h34][5:4];
        fb_uop_ram_4_inst = {_RANDOM[9'h34][31:15], _RANDOM[9'h35][14:0]};
        fb_uop_ram_4_debug_inst = {_RANDOM[9'h35][31:15], _RANDOM[9'h36][14:0]};
        fb_uop_ram_4_is_rvc = _RANDOM[9'h36][15];
        fb_uop_ram_4_debug_pc = {_RANDOM[9'h36][31:16], _RANDOM[9'h37][23:0]};
        fb_uop_ram_4_is_sfb = _RANDOM[9'h39][4];
        fb_uop_ram_4_ftq_idx = {_RANDOM[9'h39][31:30], _RANDOM[9'h3A][3:0]};
        fb_uop_ram_4_edge_inst = _RANDOM[9'h3A][4];
        fb_uop_ram_4_pc_lob = _RANDOM[9'h3A][10:5];
        fb_uop_ram_4_taken = _RANDOM[9'h3A][11];
        fb_uop_ram_4_xcpt_pf_if = _RANDOM[9'h41][1];
        fb_uop_ram_4_xcpt_ae_if = _RANDOM[9'h41][2];
        fb_uop_ram_4_bp_debug_if = _RANDOM[9'h41][4];
        fb_uop_ram_4_bp_xcpt_if = _RANDOM[9'h41][5];
        fb_uop_ram_4_debug_fsrc = _RANDOM[9'h41][7:6];
        fb_uop_ram_5_inst = {_RANDOM[9'h41][31:17], _RANDOM[9'h42][16:0]};
        fb_uop_ram_5_debug_inst = {_RANDOM[9'h42][31:17], _RANDOM[9'h43][16:0]};
        fb_uop_ram_5_is_rvc = _RANDOM[9'h43][17];
        fb_uop_ram_5_debug_pc = {_RANDOM[9'h43][31:18], _RANDOM[9'h44][25:0]};
        fb_uop_ram_5_is_sfb = _RANDOM[9'h46][6];
        fb_uop_ram_5_ftq_idx = _RANDOM[9'h47][5:0];
        fb_uop_ram_5_edge_inst = _RANDOM[9'h47][6];
        fb_uop_ram_5_pc_lob = _RANDOM[9'h47][12:7];
        fb_uop_ram_5_taken = _RANDOM[9'h47][13];
        fb_uop_ram_5_xcpt_pf_if = _RANDOM[9'h4E][3];
        fb_uop_ram_5_xcpt_ae_if = _RANDOM[9'h4E][4];
        fb_uop_ram_5_bp_debug_if = _RANDOM[9'h4E][6];
        fb_uop_ram_5_bp_xcpt_if = _RANDOM[9'h4E][7];
        fb_uop_ram_5_debug_fsrc = _RANDOM[9'h4E][9:8];
        fb_uop_ram_6_inst = {_RANDOM[9'h4E][31:19], _RANDOM[9'h4F][18:0]};
        fb_uop_ram_6_debug_inst = {_RANDOM[9'h4F][31:19], _RANDOM[9'h50][18:0]};
        fb_uop_ram_6_is_rvc = _RANDOM[9'h50][19];
        fb_uop_ram_6_debug_pc = {_RANDOM[9'h50][31:20], _RANDOM[9'h51][27:0]};
        fb_uop_ram_6_is_sfb = _RANDOM[9'h53][8];
        fb_uop_ram_6_ftq_idx = _RANDOM[9'h54][7:2];
        fb_uop_ram_6_edge_inst = _RANDOM[9'h54][8];
        fb_uop_ram_6_pc_lob = _RANDOM[9'h54][14:9];
        fb_uop_ram_6_taken = _RANDOM[9'h54][15];
        fb_uop_ram_6_xcpt_pf_if = _RANDOM[9'h5B][5];
        fb_uop_ram_6_xcpt_ae_if = _RANDOM[9'h5B][6];
        fb_uop_ram_6_bp_debug_if = _RANDOM[9'h5B][8];
        fb_uop_ram_6_bp_xcpt_if = _RANDOM[9'h5B][9];
        fb_uop_ram_6_debug_fsrc = _RANDOM[9'h5B][11:10];
        fb_uop_ram_7_inst = {_RANDOM[9'h5B][31:21], _RANDOM[9'h5C][20:0]};
        fb_uop_ram_7_debug_inst = {_RANDOM[9'h5C][31:21], _RANDOM[9'h5D][20:0]};
        fb_uop_ram_7_is_rvc = _RANDOM[9'h5D][21];
        fb_uop_ram_7_debug_pc = {_RANDOM[9'h5D][31:22], _RANDOM[9'h5E][29:0]};
        fb_uop_ram_7_is_sfb = _RANDOM[9'h60][10];
        fb_uop_ram_7_ftq_idx = _RANDOM[9'h61][9:4];
        fb_uop_ram_7_edge_inst = _RANDOM[9'h61][10];
        fb_uop_ram_7_pc_lob = _RANDOM[9'h61][16:11];
        fb_uop_ram_7_taken = _RANDOM[9'h61][17];
        fb_uop_ram_7_xcpt_pf_if = _RANDOM[9'h68][7];
        fb_uop_ram_7_xcpt_ae_if = _RANDOM[9'h68][8];
        fb_uop_ram_7_bp_debug_if = _RANDOM[9'h68][10];
        fb_uop_ram_7_bp_xcpt_if = _RANDOM[9'h68][11];
        fb_uop_ram_7_debug_fsrc = _RANDOM[9'h68][13:12];
        fb_uop_ram_8_inst = {_RANDOM[9'h68][31:23], _RANDOM[9'h69][22:0]};
        fb_uop_ram_8_debug_inst = {_RANDOM[9'h69][31:23], _RANDOM[9'h6A][22:0]};
        fb_uop_ram_8_is_rvc = _RANDOM[9'h6A][23];
        fb_uop_ram_8_debug_pc = {_RANDOM[9'h6A][31:24], _RANDOM[9'h6B]};
        fb_uop_ram_8_is_sfb = _RANDOM[9'h6D][12];
        fb_uop_ram_8_ftq_idx = _RANDOM[9'h6E][11:6];
        fb_uop_ram_8_edge_inst = _RANDOM[9'h6E][12];
        fb_uop_ram_8_pc_lob = _RANDOM[9'h6E][18:13];
        fb_uop_ram_8_taken = _RANDOM[9'h6E][19];
        fb_uop_ram_8_xcpt_pf_if = _RANDOM[9'h75][9];
        fb_uop_ram_8_xcpt_ae_if = _RANDOM[9'h75][10];
        fb_uop_ram_8_bp_debug_if = _RANDOM[9'h75][12];
        fb_uop_ram_8_bp_xcpt_if = _RANDOM[9'h75][13];
        fb_uop_ram_8_debug_fsrc = _RANDOM[9'h75][15:14];
        fb_uop_ram_9_inst = {_RANDOM[9'h75][31:25], _RANDOM[9'h76][24:0]};
        fb_uop_ram_9_debug_inst = {_RANDOM[9'h76][31:25], _RANDOM[9'h77][24:0]};
        fb_uop_ram_9_is_rvc = _RANDOM[9'h77][25];
        fb_uop_ram_9_debug_pc = {_RANDOM[9'h77][31:26], _RANDOM[9'h78], _RANDOM[9'h79][1:0]};
        fb_uop_ram_9_is_sfb = _RANDOM[9'h7A][14];
        fb_uop_ram_9_ftq_idx = _RANDOM[9'h7B][13:8];
        fb_uop_ram_9_edge_inst = _RANDOM[9'h7B][14];
        fb_uop_ram_9_pc_lob = _RANDOM[9'h7B][20:15];
        fb_uop_ram_9_taken = _RANDOM[9'h7B][21];
        fb_uop_ram_9_xcpt_pf_if = _RANDOM[9'h82][11];
        fb_uop_ram_9_xcpt_ae_if = _RANDOM[9'h82][12];
        fb_uop_ram_9_bp_debug_if = _RANDOM[9'h82][14];
        fb_uop_ram_9_bp_xcpt_if = _RANDOM[9'h82][15];
        fb_uop_ram_9_debug_fsrc = _RANDOM[9'h82][17:16];
        fb_uop_ram_10_inst = {_RANDOM[9'h82][31:27], _RANDOM[9'h83][26:0]};
        fb_uop_ram_10_debug_inst = {_RANDOM[9'h83][31:27], _RANDOM[9'h84][26:0]};
        fb_uop_ram_10_is_rvc = _RANDOM[9'h84][27];
        fb_uop_ram_10_debug_pc = {_RANDOM[9'h84][31:28], _RANDOM[9'h85], _RANDOM[9'h86][3:0]};
        fb_uop_ram_10_is_sfb = _RANDOM[9'h87][16];
        fb_uop_ram_10_ftq_idx = _RANDOM[9'h88][15:10];
        fb_uop_ram_10_edge_inst = _RANDOM[9'h88][16];
        fb_uop_ram_10_pc_lob = _RANDOM[9'h88][22:17];
        fb_uop_ram_10_taken = _RANDOM[9'h88][23];
        fb_uop_ram_10_xcpt_pf_if = _RANDOM[9'h8F][13];
        fb_uop_ram_10_xcpt_ae_if = _RANDOM[9'h8F][14];
        fb_uop_ram_10_bp_debug_if = _RANDOM[9'h8F][16];
        fb_uop_ram_10_bp_xcpt_if = _RANDOM[9'h8F][17];
        fb_uop_ram_10_debug_fsrc = _RANDOM[9'h8F][19:18];
        fb_uop_ram_11_inst = {_RANDOM[9'h8F][31:29], _RANDOM[9'h90][28:0]};
        fb_uop_ram_11_debug_inst = {_RANDOM[9'h90][31:29], _RANDOM[9'h91][28:0]};
        fb_uop_ram_11_is_rvc = _RANDOM[9'h91][29];
        fb_uop_ram_11_debug_pc = {_RANDOM[9'h91][31:30], _RANDOM[9'h92], _RANDOM[9'h93][5:0]};
        fb_uop_ram_11_is_sfb = _RANDOM[9'h94][18];
        fb_uop_ram_11_ftq_idx = _RANDOM[9'h95][17:12];
        fb_uop_ram_11_edge_inst = _RANDOM[9'h95][18];
        fb_uop_ram_11_pc_lob = _RANDOM[9'h95][24:19];
        fb_uop_ram_11_taken = _RANDOM[9'h95][25];
        fb_uop_ram_11_xcpt_pf_if = _RANDOM[9'h9C][15];
        fb_uop_ram_11_xcpt_ae_if = _RANDOM[9'h9C][16];
        fb_uop_ram_11_bp_debug_if = _RANDOM[9'h9C][18];
        fb_uop_ram_11_bp_xcpt_if = _RANDOM[9'h9C][19];
        fb_uop_ram_11_debug_fsrc = _RANDOM[9'h9C][21:20];
        fb_uop_ram_12_inst = {_RANDOM[9'h9C][31], _RANDOM[9'h9D][30:0]};
        fb_uop_ram_12_debug_inst = {_RANDOM[9'h9D][31], _RANDOM[9'h9E][30:0]};
        fb_uop_ram_12_is_rvc = _RANDOM[9'h9E][31];
        fb_uop_ram_12_debug_pc = {_RANDOM[9'h9F], _RANDOM[9'hA0][7:0]};
        fb_uop_ram_12_is_sfb = _RANDOM[9'hA1][20];
        fb_uop_ram_12_ftq_idx = _RANDOM[9'hA2][19:14];
        fb_uop_ram_12_edge_inst = _RANDOM[9'hA2][20];
        fb_uop_ram_12_pc_lob = _RANDOM[9'hA2][26:21];
        fb_uop_ram_12_taken = _RANDOM[9'hA2][27];
        fb_uop_ram_12_xcpt_pf_if = _RANDOM[9'hA9][17];
        fb_uop_ram_12_xcpt_ae_if = _RANDOM[9'hA9][18];
        fb_uop_ram_12_bp_debug_if = _RANDOM[9'hA9][20];
        fb_uop_ram_12_bp_xcpt_if = _RANDOM[9'hA9][21];
        fb_uop_ram_12_debug_fsrc = _RANDOM[9'hA9][23:22];
        fb_uop_ram_13_inst = {_RANDOM[9'hAA][31:1], _RANDOM[9'hAB][0]};
        fb_uop_ram_13_debug_inst = {_RANDOM[9'hAB][31:1], _RANDOM[9'hAC][0]};
        fb_uop_ram_13_is_rvc = _RANDOM[9'hAC][1];
        fb_uop_ram_13_debug_pc = {_RANDOM[9'hAC][31:2], _RANDOM[9'hAD][9:0]};
        fb_uop_ram_13_is_sfb = _RANDOM[9'hAE][22];
        fb_uop_ram_13_ftq_idx = _RANDOM[9'hAF][21:16];
        fb_uop_ram_13_edge_inst = _RANDOM[9'hAF][22];
        fb_uop_ram_13_pc_lob = _RANDOM[9'hAF][28:23];
        fb_uop_ram_13_taken = _RANDOM[9'hAF][29];
        fb_uop_ram_13_xcpt_pf_if = _RANDOM[9'hB6][19];
        fb_uop_ram_13_xcpt_ae_if = _RANDOM[9'hB6][20];
        fb_uop_ram_13_bp_debug_if = _RANDOM[9'hB6][22];
        fb_uop_ram_13_bp_xcpt_if = _RANDOM[9'hB6][23];
        fb_uop_ram_13_debug_fsrc = _RANDOM[9'hB6][25:24];
        fb_uop_ram_14_inst = {_RANDOM[9'hB7][31:3], _RANDOM[9'hB8][2:0]};
        fb_uop_ram_14_debug_inst = {_RANDOM[9'hB8][31:3], _RANDOM[9'hB9][2:0]};
        fb_uop_ram_14_is_rvc = _RANDOM[9'hB9][3];
        fb_uop_ram_14_debug_pc = {_RANDOM[9'hB9][31:4], _RANDOM[9'hBA][11:0]};
        fb_uop_ram_14_is_sfb = _RANDOM[9'hBB][24];
        fb_uop_ram_14_ftq_idx = _RANDOM[9'hBC][23:18];
        fb_uop_ram_14_edge_inst = _RANDOM[9'hBC][24];
        fb_uop_ram_14_pc_lob = _RANDOM[9'hBC][30:25];
        fb_uop_ram_14_taken = _RANDOM[9'hBC][31];
        fb_uop_ram_14_xcpt_pf_if = _RANDOM[9'hC3][21];
        fb_uop_ram_14_xcpt_ae_if = _RANDOM[9'hC3][22];
        fb_uop_ram_14_bp_debug_if = _RANDOM[9'hC3][24];
        fb_uop_ram_14_bp_xcpt_if = _RANDOM[9'hC3][25];
        fb_uop_ram_14_debug_fsrc = _RANDOM[9'hC3][27:26];
        fb_uop_ram_15_inst = {_RANDOM[9'hC4][31:5], _RANDOM[9'hC5][4:0]};
        fb_uop_ram_15_debug_inst = {_RANDOM[9'hC5][31:5], _RANDOM[9'hC6][4:0]};
        fb_uop_ram_15_is_rvc = _RANDOM[9'hC6][5];
        fb_uop_ram_15_debug_pc = {_RANDOM[9'hC6][31:6], _RANDOM[9'hC7][13:0]};
        fb_uop_ram_15_is_sfb = _RANDOM[9'hC8][26];
        fb_uop_ram_15_ftq_idx = _RANDOM[9'hC9][25:20];
        fb_uop_ram_15_edge_inst = _RANDOM[9'hC9][26];
        fb_uop_ram_15_pc_lob = {_RANDOM[9'hC9][31:27], _RANDOM[9'hCA][0]};
        fb_uop_ram_15_taken = _RANDOM[9'hCA][1];
        fb_uop_ram_15_xcpt_pf_if = _RANDOM[9'hD0][23];
        fb_uop_ram_15_xcpt_ae_if = _RANDOM[9'hD0][24];
        fb_uop_ram_15_bp_debug_if = _RANDOM[9'hD0][26];
        fb_uop_ram_15_bp_xcpt_if = _RANDOM[9'hD0][27];
        fb_uop_ram_15_debug_fsrc = _RANDOM[9'hD0][29:28];
        fb_uop_ram_16_inst = {_RANDOM[9'hD1][31:7], _RANDOM[9'hD2][6:0]};
        fb_uop_ram_16_debug_inst = {_RANDOM[9'hD2][31:7], _RANDOM[9'hD3][6:0]};
        fb_uop_ram_16_is_rvc = _RANDOM[9'hD3][7];
        fb_uop_ram_16_debug_pc = {_RANDOM[9'hD3][31:8], _RANDOM[9'hD4][15:0]};
        fb_uop_ram_16_is_sfb = _RANDOM[9'hD5][28];
        fb_uop_ram_16_ftq_idx = _RANDOM[9'hD6][27:22];
        fb_uop_ram_16_edge_inst = _RANDOM[9'hD6][28];
        fb_uop_ram_16_pc_lob = {_RANDOM[9'hD6][31:29], _RANDOM[9'hD7][2:0]};
        fb_uop_ram_16_taken = _RANDOM[9'hD7][3];
        fb_uop_ram_16_xcpt_pf_if = _RANDOM[9'hDD][25];
        fb_uop_ram_16_xcpt_ae_if = _RANDOM[9'hDD][26];
        fb_uop_ram_16_bp_debug_if = _RANDOM[9'hDD][28];
        fb_uop_ram_16_bp_xcpt_if = _RANDOM[9'hDD][29];
        fb_uop_ram_16_debug_fsrc = _RANDOM[9'hDD][31:30];
        fb_uop_ram_17_inst = {_RANDOM[9'hDE][31:9], _RANDOM[9'hDF][8:0]};
        fb_uop_ram_17_debug_inst = {_RANDOM[9'hDF][31:9], _RANDOM[9'hE0][8:0]};
        fb_uop_ram_17_is_rvc = _RANDOM[9'hE0][9];
        fb_uop_ram_17_debug_pc = {_RANDOM[9'hE0][31:10], _RANDOM[9'hE1][17:0]};
        fb_uop_ram_17_is_sfb = _RANDOM[9'hE2][30];
        fb_uop_ram_17_ftq_idx = _RANDOM[9'hE3][29:24];
        fb_uop_ram_17_edge_inst = _RANDOM[9'hE3][30];
        fb_uop_ram_17_pc_lob = {_RANDOM[9'hE3][31], _RANDOM[9'hE4][4:0]};
        fb_uop_ram_17_taken = _RANDOM[9'hE4][5];
        fb_uop_ram_17_xcpt_pf_if = _RANDOM[9'hEA][27];
        fb_uop_ram_17_xcpt_ae_if = _RANDOM[9'hEA][28];
        fb_uop_ram_17_bp_debug_if = _RANDOM[9'hEA][30];
        fb_uop_ram_17_bp_xcpt_if = _RANDOM[9'hEA][31];
        fb_uop_ram_17_debug_fsrc = _RANDOM[9'hEB][1:0];
        fb_uop_ram_18_inst = {_RANDOM[9'hEB][31:11], _RANDOM[9'hEC][10:0]};
        fb_uop_ram_18_debug_inst = {_RANDOM[9'hEC][31:11], _RANDOM[9'hED][10:0]};
        fb_uop_ram_18_is_rvc = _RANDOM[9'hED][11];
        fb_uop_ram_18_debug_pc = {_RANDOM[9'hED][31:12], _RANDOM[9'hEE][19:0]};
        fb_uop_ram_18_is_sfb = _RANDOM[9'hF0][0];
        fb_uop_ram_18_ftq_idx = _RANDOM[9'hF0][31:26];
        fb_uop_ram_18_edge_inst = _RANDOM[9'hF1][0];
        fb_uop_ram_18_pc_lob = _RANDOM[9'hF1][6:1];
        fb_uop_ram_18_taken = _RANDOM[9'hF1][7];
        fb_uop_ram_18_xcpt_pf_if = _RANDOM[9'hF7][29];
        fb_uop_ram_18_xcpt_ae_if = _RANDOM[9'hF7][30];
        fb_uop_ram_18_bp_debug_if = _RANDOM[9'hF8][0];
        fb_uop_ram_18_bp_xcpt_if = _RANDOM[9'hF8][1];
        fb_uop_ram_18_debug_fsrc = _RANDOM[9'hF8][3:2];
        fb_uop_ram_19_inst = {_RANDOM[9'hF8][31:13], _RANDOM[9'hF9][12:0]};
        fb_uop_ram_19_debug_inst = {_RANDOM[9'hF9][31:13], _RANDOM[9'hFA][12:0]};
        fb_uop_ram_19_is_rvc = _RANDOM[9'hFA][13];
        fb_uop_ram_19_debug_pc = {_RANDOM[9'hFA][31:14], _RANDOM[9'hFB][21:0]};
        fb_uop_ram_19_is_sfb = _RANDOM[9'hFD][2];
        fb_uop_ram_19_ftq_idx = {_RANDOM[9'hFD][31:28], _RANDOM[9'hFE][1:0]};
        fb_uop_ram_19_edge_inst = _RANDOM[9'hFE][2];
        fb_uop_ram_19_pc_lob = _RANDOM[9'hFE][8:3];
        fb_uop_ram_19_taken = _RANDOM[9'hFE][9];
        fb_uop_ram_19_xcpt_pf_if = _RANDOM[9'h104][31];
        fb_uop_ram_19_xcpt_ae_if = _RANDOM[9'h105][0];
        fb_uop_ram_19_bp_debug_if = _RANDOM[9'h105][2];
        fb_uop_ram_19_bp_xcpt_if = _RANDOM[9'h105][3];
        fb_uop_ram_19_debug_fsrc = _RANDOM[9'h105][5:4];
        fb_uop_ram_20_inst = {_RANDOM[9'h105][31:15], _RANDOM[9'h106][14:0]};
        fb_uop_ram_20_debug_inst = {_RANDOM[9'h106][31:15], _RANDOM[9'h107][14:0]};
        fb_uop_ram_20_is_rvc = _RANDOM[9'h107][15];
        fb_uop_ram_20_debug_pc = {_RANDOM[9'h107][31:16], _RANDOM[9'h108][23:0]};
        fb_uop_ram_20_is_sfb = _RANDOM[9'h10A][4];
        fb_uop_ram_20_ftq_idx = {_RANDOM[9'h10A][31:30], _RANDOM[9'h10B][3:0]};
        fb_uop_ram_20_edge_inst = _RANDOM[9'h10B][4];
        fb_uop_ram_20_pc_lob = _RANDOM[9'h10B][10:5];
        fb_uop_ram_20_taken = _RANDOM[9'h10B][11];
        fb_uop_ram_20_xcpt_pf_if = _RANDOM[9'h112][1];
        fb_uop_ram_20_xcpt_ae_if = _RANDOM[9'h112][2];
        fb_uop_ram_20_bp_debug_if = _RANDOM[9'h112][4];
        fb_uop_ram_20_bp_xcpt_if = _RANDOM[9'h112][5];
        fb_uop_ram_20_debug_fsrc = _RANDOM[9'h112][7:6];
        fb_uop_ram_21_inst = {_RANDOM[9'h112][31:17], _RANDOM[9'h113][16:0]};
        fb_uop_ram_21_debug_inst = {_RANDOM[9'h113][31:17], _RANDOM[9'h114][16:0]};
        fb_uop_ram_21_is_rvc = _RANDOM[9'h114][17];
        fb_uop_ram_21_debug_pc = {_RANDOM[9'h114][31:18], _RANDOM[9'h115][25:0]};
        fb_uop_ram_21_is_sfb = _RANDOM[9'h117][6];
        fb_uop_ram_21_ftq_idx = _RANDOM[9'h118][5:0];
        fb_uop_ram_21_edge_inst = _RANDOM[9'h118][6];
        fb_uop_ram_21_pc_lob = _RANDOM[9'h118][12:7];
        fb_uop_ram_21_taken = _RANDOM[9'h118][13];
        fb_uop_ram_21_xcpt_pf_if = _RANDOM[9'h11F][3];
        fb_uop_ram_21_xcpt_ae_if = _RANDOM[9'h11F][4];
        fb_uop_ram_21_bp_debug_if = _RANDOM[9'h11F][6];
        fb_uop_ram_21_bp_xcpt_if = _RANDOM[9'h11F][7];
        fb_uop_ram_21_debug_fsrc = _RANDOM[9'h11F][9:8];
        fb_uop_ram_22_inst = {_RANDOM[9'h11F][31:19], _RANDOM[9'h120][18:0]};
        fb_uop_ram_22_debug_inst = {_RANDOM[9'h120][31:19], _RANDOM[9'h121][18:0]};
        fb_uop_ram_22_is_rvc = _RANDOM[9'h121][19];
        fb_uop_ram_22_debug_pc = {_RANDOM[9'h121][31:20], _RANDOM[9'h122][27:0]};
        fb_uop_ram_22_is_sfb = _RANDOM[9'h124][8];
        fb_uop_ram_22_ftq_idx = _RANDOM[9'h125][7:2];
        fb_uop_ram_22_edge_inst = _RANDOM[9'h125][8];
        fb_uop_ram_22_pc_lob = _RANDOM[9'h125][14:9];
        fb_uop_ram_22_taken = _RANDOM[9'h125][15];
        fb_uop_ram_22_xcpt_pf_if = _RANDOM[9'h12C][5];
        fb_uop_ram_22_xcpt_ae_if = _RANDOM[9'h12C][6];
        fb_uop_ram_22_bp_debug_if = _RANDOM[9'h12C][8];
        fb_uop_ram_22_bp_xcpt_if = _RANDOM[9'h12C][9];
        fb_uop_ram_22_debug_fsrc = _RANDOM[9'h12C][11:10];
        fb_uop_ram_23_inst = {_RANDOM[9'h12C][31:21], _RANDOM[9'h12D][20:0]};
        fb_uop_ram_23_debug_inst = {_RANDOM[9'h12D][31:21], _RANDOM[9'h12E][20:0]};
        fb_uop_ram_23_is_rvc = _RANDOM[9'h12E][21];
        fb_uop_ram_23_debug_pc = {_RANDOM[9'h12E][31:22], _RANDOM[9'h12F][29:0]};
        fb_uop_ram_23_is_sfb = _RANDOM[9'h131][10];
        fb_uop_ram_23_ftq_idx = _RANDOM[9'h132][9:4];
        fb_uop_ram_23_edge_inst = _RANDOM[9'h132][10];
        fb_uop_ram_23_pc_lob = _RANDOM[9'h132][16:11];
        fb_uop_ram_23_taken = _RANDOM[9'h132][17];
        fb_uop_ram_23_xcpt_pf_if = _RANDOM[9'h139][7];
        fb_uop_ram_23_xcpt_ae_if = _RANDOM[9'h139][8];
        fb_uop_ram_23_bp_debug_if = _RANDOM[9'h139][10];
        fb_uop_ram_23_bp_xcpt_if = _RANDOM[9'h139][11];
        fb_uop_ram_23_debug_fsrc = _RANDOM[9'h139][13:12];
        fb_uop_ram_24_inst = {_RANDOM[9'h139][31:23], _RANDOM[9'h13A][22:0]};
        fb_uop_ram_24_debug_inst = {_RANDOM[9'h13A][31:23], _RANDOM[9'h13B][22:0]};
        fb_uop_ram_24_is_rvc = _RANDOM[9'h13B][23];
        fb_uop_ram_24_debug_pc = {_RANDOM[9'h13B][31:24], _RANDOM[9'h13C]};
        fb_uop_ram_24_is_sfb = _RANDOM[9'h13E][12];
        fb_uop_ram_24_ftq_idx = _RANDOM[9'h13F][11:6];
        fb_uop_ram_24_edge_inst = _RANDOM[9'h13F][12];
        fb_uop_ram_24_pc_lob = _RANDOM[9'h13F][18:13];
        fb_uop_ram_24_taken = _RANDOM[9'h13F][19];
        fb_uop_ram_24_xcpt_pf_if = _RANDOM[9'h146][9];
        fb_uop_ram_24_xcpt_ae_if = _RANDOM[9'h146][10];
        fb_uop_ram_24_bp_debug_if = _RANDOM[9'h146][12];
        fb_uop_ram_24_bp_xcpt_if = _RANDOM[9'h146][13];
        fb_uop_ram_24_debug_fsrc = _RANDOM[9'h146][15:14];
        fb_uop_ram_25_inst = {_RANDOM[9'h146][31:25], _RANDOM[9'h147][24:0]};
        fb_uop_ram_25_debug_inst = {_RANDOM[9'h147][31:25], _RANDOM[9'h148][24:0]};
        fb_uop_ram_25_is_rvc = _RANDOM[9'h148][25];
        fb_uop_ram_25_debug_pc = {_RANDOM[9'h148][31:26], _RANDOM[9'h149], _RANDOM[9'h14A][1:0]};
        fb_uop_ram_25_is_sfb = _RANDOM[9'h14B][14];
        fb_uop_ram_25_ftq_idx = _RANDOM[9'h14C][13:8];
        fb_uop_ram_25_edge_inst = _RANDOM[9'h14C][14];
        fb_uop_ram_25_pc_lob = _RANDOM[9'h14C][20:15];
        fb_uop_ram_25_taken = _RANDOM[9'h14C][21];
        fb_uop_ram_25_xcpt_pf_if = _RANDOM[9'h153][11];
        fb_uop_ram_25_xcpt_ae_if = _RANDOM[9'h153][12];
        fb_uop_ram_25_bp_debug_if = _RANDOM[9'h153][14];
        fb_uop_ram_25_bp_xcpt_if = _RANDOM[9'h153][15];
        fb_uop_ram_25_debug_fsrc = _RANDOM[9'h153][17:16];
        fb_uop_ram_26_inst = {_RANDOM[9'h153][31:27], _RANDOM[9'h154][26:0]};
        fb_uop_ram_26_debug_inst = {_RANDOM[9'h154][31:27], _RANDOM[9'h155][26:0]};
        fb_uop_ram_26_is_rvc = _RANDOM[9'h155][27];
        fb_uop_ram_26_debug_pc = {_RANDOM[9'h155][31:28], _RANDOM[9'h156], _RANDOM[9'h157][3:0]};
        fb_uop_ram_26_is_sfb = _RANDOM[9'h158][16];
        fb_uop_ram_26_ftq_idx = _RANDOM[9'h159][15:10];
        fb_uop_ram_26_edge_inst = _RANDOM[9'h159][16];
        fb_uop_ram_26_pc_lob = _RANDOM[9'h159][22:17];
        fb_uop_ram_26_taken = _RANDOM[9'h159][23];
        fb_uop_ram_26_xcpt_pf_if = _RANDOM[9'h160][13];
        fb_uop_ram_26_xcpt_ae_if = _RANDOM[9'h160][14];
        fb_uop_ram_26_bp_debug_if = _RANDOM[9'h160][16];
        fb_uop_ram_26_bp_xcpt_if = _RANDOM[9'h160][17];
        fb_uop_ram_26_debug_fsrc = _RANDOM[9'h160][19:18];
        fb_uop_ram_27_inst = {_RANDOM[9'h160][31:29], _RANDOM[9'h161][28:0]};
        fb_uop_ram_27_debug_inst = {_RANDOM[9'h161][31:29], _RANDOM[9'h162][28:0]};
        fb_uop_ram_27_is_rvc = _RANDOM[9'h162][29];
        fb_uop_ram_27_debug_pc = {_RANDOM[9'h162][31:30], _RANDOM[9'h163], _RANDOM[9'h164][5:0]};
        fb_uop_ram_27_is_sfb = _RANDOM[9'h165][18];
        fb_uop_ram_27_ftq_idx = _RANDOM[9'h166][17:12];
        fb_uop_ram_27_edge_inst = _RANDOM[9'h166][18];
        fb_uop_ram_27_pc_lob = _RANDOM[9'h166][24:19];
        fb_uop_ram_27_taken = _RANDOM[9'h166][25];
        fb_uop_ram_27_xcpt_pf_if = _RANDOM[9'h16D][15];
        fb_uop_ram_27_xcpt_ae_if = _RANDOM[9'h16D][16];
        fb_uop_ram_27_bp_debug_if = _RANDOM[9'h16D][18];
        fb_uop_ram_27_bp_xcpt_if = _RANDOM[9'h16D][19];
        fb_uop_ram_27_debug_fsrc = _RANDOM[9'h16D][21:20];
        fb_uop_ram_28_inst = {_RANDOM[9'h16D][31], _RANDOM[9'h16E][30:0]};
        fb_uop_ram_28_debug_inst = {_RANDOM[9'h16E][31], _RANDOM[9'h16F][30:0]};
        fb_uop_ram_28_is_rvc = _RANDOM[9'h16F][31];
        fb_uop_ram_28_debug_pc = {_RANDOM[9'h170], _RANDOM[9'h171][7:0]};
        fb_uop_ram_28_is_sfb = _RANDOM[9'h172][20];
        fb_uop_ram_28_ftq_idx = _RANDOM[9'h173][19:14];
        fb_uop_ram_28_edge_inst = _RANDOM[9'h173][20];
        fb_uop_ram_28_pc_lob = _RANDOM[9'h173][26:21];
        fb_uop_ram_28_taken = _RANDOM[9'h173][27];
        fb_uop_ram_28_xcpt_pf_if = _RANDOM[9'h17A][17];
        fb_uop_ram_28_xcpt_ae_if = _RANDOM[9'h17A][18];
        fb_uop_ram_28_bp_debug_if = _RANDOM[9'h17A][20];
        fb_uop_ram_28_bp_xcpt_if = _RANDOM[9'h17A][21];
        fb_uop_ram_28_debug_fsrc = _RANDOM[9'h17A][23:22];
        fb_uop_ram_29_inst = {_RANDOM[9'h17B][31:1], _RANDOM[9'h17C][0]};
        fb_uop_ram_29_debug_inst = {_RANDOM[9'h17C][31:1], _RANDOM[9'h17D][0]};
        fb_uop_ram_29_is_rvc = _RANDOM[9'h17D][1];
        fb_uop_ram_29_debug_pc = {_RANDOM[9'h17D][31:2], _RANDOM[9'h17E][9:0]};
        fb_uop_ram_29_is_sfb = _RANDOM[9'h17F][22];
        fb_uop_ram_29_ftq_idx = _RANDOM[9'h180][21:16];
        fb_uop_ram_29_edge_inst = _RANDOM[9'h180][22];
        fb_uop_ram_29_pc_lob = _RANDOM[9'h180][28:23];
        fb_uop_ram_29_taken = _RANDOM[9'h180][29];
        fb_uop_ram_29_xcpt_pf_if = _RANDOM[9'h187][19];
        fb_uop_ram_29_xcpt_ae_if = _RANDOM[9'h187][20];
        fb_uop_ram_29_bp_debug_if = _RANDOM[9'h187][22];
        fb_uop_ram_29_bp_xcpt_if = _RANDOM[9'h187][23];
        fb_uop_ram_29_debug_fsrc = _RANDOM[9'h187][25:24];
        fb_uop_ram_30_inst = {_RANDOM[9'h188][31:3], _RANDOM[9'h189][2:0]};
        fb_uop_ram_30_debug_inst = {_RANDOM[9'h189][31:3], _RANDOM[9'h18A][2:0]};
        fb_uop_ram_30_is_rvc = _RANDOM[9'h18A][3];
        fb_uop_ram_30_debug_pc = {_RANDOM[9'h18A][31:4], _RANDOM[9'h18B][11:0]};
        fb_uop_ram_30_is_sfb = _RANDOM[9'h18C][24];
        fb_uop_ram_30_ftq_idx = _RANDOM[9'h18D][23:18];
        fb_uop_ram_30_edge_inst = _RANDOM[9'h18D][24];
        fb_uop_ram_30_pc_lob = _RANDOM[9'h18D][30:25];
        fb_uop_ram_30_taken = _RANDOM[9'h18D][31];
        fb_uop_ram_30_xcpt_pf_if = _RANDOM[9'h194][21];
        fb_uop_ram_30_xcpt_ae_if = _RANDOM[9'h194][22];
        fb_uop_ram_30_bp_debug_if = _RANDOM[9'h194][24];
        fb_uop_ram_30_bp_xcpt_if = _RANDOM[9'h194][25];
        fb_uop_ram_30_debug_fsrc = _RANDOM[9'h194][27:26];
        fb_uop_ram_31_inst = {_RANDOM[9'h195][31:5], _RANDOM[9'h196][4:0]};
        fb_uop_ram_31_debug_inst = {_RANDOM[9'h196][31:5], _RANDOM[9'h197][4:0]};
        fb_uop_ram_31_is_rvc = _RANDOM[9'h197][5];
        fb_uop_ram_31_debug_pc = {_RANDOM[9'h197][31:6], _RANDOM[9'h198][13:0]};
        fb_uop_ram_31_is_sfb = _RANDOM[9'h199][26];
        fb_uop_ram_31_ftq_idx = _RANDOM[9'h19A][25:20];
        fb_uop_ram_31_edge_inst = _RANDOM[9'h19A][26];
        fb_uop_ram_31_pc_lob = {_RANDOM[9'h19A][31:27], _RANDOM[9'h19B][0]};
        fb_uop_ram_31_taken = _RANDOM[9'h19B][1];
        fb_uop_ram_31_xcpt_pf_if = _RANDOM[9'h1A1][23];
        fb_uop_ram_31_xcpt_ae_if = _RANDOM[9'h1A1][24];
        fb_uop_ram_31_bp_debug_if = _RANDOM[9'h1A1][26];
        fb_uop_ram_31_bp_xcpt_if = _RANDOM[9'h1A1][27];
        fb_uop_ram_31_debug_fsrc = _RANDOM[9'h1A1][29:28];
        head = _RANDOM[9'h1A2][7:0];
        tail = {_RANDOM[9'h1A2][31:8], _RANDOM[9'h1A3][7:0]};
        maybe_full = _RANDOM[9'h1A3][8];
      `endif // RANDOMIZE_REG_INIT
    end // initial
