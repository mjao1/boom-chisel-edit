...
module RenameBusyTable(
  ...
  input  [6:0] io_ren_uops_2_pdst,
  input  [6:0] io_ren_uops_2_prs1,
  input  [6:0] io_ren_uops_2_prs2,
  input  [6:0] io_ren_uops_3_pdst,
  input  [6:0] io_ren_uops_3_prs1,
  input  [6:0] io_ren_uops_3_prs2,
  ...
  output       io_busy_resps_2_prs1_busy,
  output       io_busy_resps_2_prs2_busy,
  output       io_busy_resps_3_prs1_busy,
  output       io_busy_resps_3_prs2_busy,
  ...
  input  [6:0] io_wb_pdsts_5,
  input  [6:0] io_wb_pdsts_6,
  input  [6:0] io_wb_pdsts_7,
  input  [6:0] io_wb_pdsts_8,
  input  [6:0] io_wb_pdsts_9,
  input        io_wb_valids_0,
  input        io_wb_valids_1,
  input        io_wb_valids_2,
  input        io_wb_valids_3,
  input        io_wb_valids_4,
  input        io_wb_valids_5,
  input        io_wb_valids_6,
  input        io_wb_valids_7,
  input        io_wb_valids_8,
  input        io_wb_valids_9
);
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        busy_table = {_RANDOM[2'h0], _RANDOM[2'h1], _RANDOM[2'h2], _RANDOM[2'h3]};
      `endif // RANDOMIZE_REG_INIT
    end // initial
