...
module BoomCore(
  ...
  wire            dec_ready = dec_valids_3 & ~(dec_stalls_2 | dec_valids_3 & ((|{dis_stalls_3 | _rob_io_commit_rollback | dec_xcpt_stall | _dec_brmask_logic_io_is_full_3, _b1_mispredict_mask_T_10}) | b2_mispredict | rename_stage_io_kill));
  ...
  always @(posedge clock) begin
    ...
    if (reset) begin
      ...
      dec_finished_mask <= dec_ready | rename_stage_io_kill ? 4'h0 : {dec_ready, dec_fire_2, dec_fire_1, dec_fire_0} | dec_finished_mask;
