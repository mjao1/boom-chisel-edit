  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        io_dis_uops_0_ready_REG = _RANDOM[/*Zero width*/ 1'b0][0];
        io_dis_uops_1_ready_REG = _RANDOM[/*Zero width*/ 1'b0][1];
        io_dis_uops_2_ready_REG = _RANDOM[/*Zero width*/ 1'b0][2];
        io_dis_uops_3_ready_REG = _RANDOM[/*Zero width*/ 1'b0][3];
      `endif // RANDOMIZE_REG_INIT
    end // initial
