  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        reset_idx = _RANDOM[2'h0][8:1];
        s2_tag = _RANDOM[2'h0][16:9];
        ...
        clear_u_ctr = _RANDOM[2'h1][28:9];
        wrbypass_tags_0 = {_RANDOM[2'h1][31:29], _RANDOM[2'h2][4:0]};
        wrbypass_tags_1 = _RANDOM[2'h2][12:5];
        wrbypass_idxs_0 = _RANDOM[2'h2][20:13];
        wrbypass_idxs_1 = _RANDOM[2'h2][28:21];
        wrbypass_0_0 = _RANDOM[2'h2][31:29];
        wrbypass_0_1 = _RANDOM[2'h3][2:0];
        wrbypass_0_2 = _RANDOM[2'h3][5:3];
        wrbypass_0_3 = _RANDOM[2'h3][8:6];
        wrbypass_1_0 = _RANDOM[2'h3][11:9];
        wrbypass_1_1 = _RANDOM[2'h3][14:12];
        wrbypass_1_2 = _RANDOM[2'h3][17:15];
        wrbypass_1_3 = _RANDOM[2'h3][20:18];
        wrbypass_enq_idx = _RANDOM[2'h3][21];
      `endif // RANDOMIZE_REG_INIT
    end // initial
