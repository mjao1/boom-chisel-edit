...
module BTBBranchPredictorBank(
  ...
  wire         io_resp_f2_0_is_jal_0 = REG ? io_resp_f2_0_is_jal_REG : io_resp_in_0_f2_0_is_jal;
  reg          REG_1;
  reg          REG_2;
  reg          REG_3;
  ...
  wire         io_resp_f2_1_is_jal_0 = REG_6 ? io_resp_f2_1_is_jal_REG : io_resp_in_0_f2_1_is_jal;
  reg          REG_7;
  reg          REG_8;
  reg          REG_9;
  ...
  wire         io_resp_f2_2_is_jal_0 = REG_12 ? io_resp_f2_2_is_jal_REG : io_resp_in_0_f2_2_is_jal;
  reg          REG_13;
  reg          REG_14;
  reg          REG_15;
  ...
  wire         io_resp_f2_3_is_jal_0 = REG_18 ? io_resp_f2_3_is_jal_REG : io_resp_in_0_f2_3_is_jal;
  reg          REG_19;
  reg          REG_20;
  reg          REG_21;
  ...
  always @(posedge clock) begin
    ...
    io_resp_f3_0_is_jal_REG <= io_resp_f2_0_is_jal_0;
    REG_4 <= s1_is_jal_0;
    REG_5 <= REG_4;
    REG_6 <= s1_hits_1;
    ...
    io_resp_f3_1_is_jal_REG <= io_resp_f2_1_is_jal_0;
    REG_10 <= s1_is_jal_1;
    REG_11 <= REG_10;
    REG_12 <= s1_hits_2;
    ...
    io_resp_f3_2_is_jal_REG <= io_resp_f2_2_is_jal_0;
    REG_16 <= s1_is_jal_2;
    REG_17 <= REG_16;
    REG_18 <= s1_hits_3;
    ...
    io_resp_f3_3_is_jal_REG <= io_resp_f2_3_is_jal_0;
    REG_22 <= s1_is_jal_3;
    REG_23 <= REG_22;
    if (reset) begin
      doing_reset <= 1'h1;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        REG = _RANDOM[5'hF][14];
        io_resp_f2_0_predicted_pc_REG_valid = _RANDOM[5'hF][15];
        io_resp_f2_0_predicted_pc_REG_bits = {_RANDOM[5'hF][31:16], _RANDOM[5'h10][23:0]};
        io_resp_f2_0_is_br_REG = _RANDOM[5'h10][24];
        io_resp_f2_0_is_jal_REG = _RANDOM[5'h10][25];
        REG_1 = _RANDOM[5'h10][26];
        REG_2 = _RANDOM[5'h10][27];
        REG_3 = _RANDOM[5'h10][28];
        io_resp_f3_0_predicted_pc_REG_valid = _RANDOM[5'h10][29];
        io_resp_f3_0_predicted_pc_REG_bits = {_RANDOM[5'h10][31:30], _RANDOM[5'h11], _RANDOM[5'h12][5:0]};
        io_resp_f3_0_is_br_REG = _RANDOM[5'h12][6];
        io_resp_f3_0_is_jal_REG = _RANDOM[5'h12][7];
        REG_4 = _RANDOM[5'h12][8];
        REG_5 = _RANDOM[5'h12][9];
        REG_6 = _RANDOM[5'h12][10];
        io_resp_f2_1_predicted_pc_REG_valid = _RANDOM[5'h12][11];
        io_resp_f2_1_predicted_pc_REG_bits = {_RANDOM[5'h12][31:12], _RANDOM[5'h13][19:0]};
        io_resp_f2_1_is_br_REG = _RANDOM[5'h13][20];
        io_resp_f2_1_is_jal_REG = _RANDOM[5'h13][21];
        REG_7 = _RANDOM[5'h13][22];
        REG_8 = _RANDOM[5'h13][23];
        REG_9 = _RANDOM[5'h13][24];
        io_resp_f3_1_predicted_pc_REG_valid = _RANDOM[5'h13][25];
        io_resp_f3_1_predicted_pc_REG_bits = {_RANDOM[5'h13][31:26], _RANDOM[5'h14], _RANDOM[5'h15][1:0]};
        io_resp_f3_1_is_br_REG = _RANDOM[5'h15][2];
        io_resp_f3_1_is_jal_REG = _RANDOM[5'h15][3];
        REG_10 = _RANDOM[5'h15][4];
        REG_11 = _RANDOM[5'h15][5];
        REG_12 = _RANDOM[5'h15][6];
        io_resp_f2_2_predicted_pc_REG_valid = _RANDOM[5'h15][7];
        io_resp_f2_2_predicted_pc_REG_bits = {_RANDOM[5'h15][31:8], _RANDOM[5'h16][15:0]};
        io_resp_f2_2_is_br_REG = _RANDOM[5'h16][16];
        io_resp_f2_2_is_jal_REG = _RANDOM[5'h16][17];
        REG_13 = _RANDOM[5'h16][18];
        REG_14 = _RANDOM[5'h16][19];
        REG_15 = _RANDOM[5'h16][20];
        io_resp_f3_2_predicted_pc_REG_valid = _RANDOM[5'h16][21];
        io_resp_f3_2_predicted_pc_REG_bits = {_RANDOM[5'h16][31:22], _RANDOM[5'h17][29:0]};
        io_resp_f3_2_is_br_REG = _RANDOM[5'h17][30];
        io_resp_f3_2_is_jal_REG = _RANDOM[5'h17][31];
        REG_16 = _RANDOM[5'h18][0];
        REG_17 = _RANDOM[5'h18][1];
        REG_18 = _RANDOM[5'h18][2];
        io_resp_f2_3_predicted_pc_REG_valid = _RANDOM[5'h18][3];
        io_resp_f2_3_predicted_pc_REG_bits = {_RANDOM[5'h18][31:4], _RANDOM[5'h19][11:0]};
        io_resp_f2_3_is_br_REG = _RANDOM[5'h19][12];
        io_resp_f2_3_is_jal_REG = _RANDOM[5'h19][13];
        REG_19 = _RANDOM[5'h19][14];
        REG_20 = _RANDOM[5'h19][15];
        REG_21 = _RANDOM[5'h19][16];
        io_resp_f3_3_predicted_pc_REG_valid = _RANDOM[5'h19][17];
        io_resp_f3_3_predicted_pc_REG_bits = {_RANDOM[5'h19][31:18], _RANDOM[5'h1A][25:0]};
        io_resp_f3_3_is_br_REG = _RANDOM[5'h1A][26];
        io_resp_f3_3_is_jal_REG = _RANDOM[5'h1A][27];
        REG_22 = _RANDOM[5'h1A][28];
        REG_23 = _RANDOM[5'h1A][29];
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_resp_f2_0_is_jal = io_resp_f2_0_is_jal_0;
  ...
  assign io_resp_f2_1_is_jal = io_resp_f2_1_is_jal_0;
  ...
  assign io_resp_f2_2_is_jal = io_resp_f2_2_is_jal_0;
  ...
  assign io_resp_f2_3_is_jal = io_resp_f2_3_is_jal_0;
